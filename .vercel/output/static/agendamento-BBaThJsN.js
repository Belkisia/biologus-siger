import{d as pe,ah as je,r as w,j as e,I as H,C as k,m as Ne,n as $,s as N,o as E,t as h,B as n,M as Re,a as Ae,ai as Ce}from"./index-C9_2v7pz.js";import{L as me}from"./label-BHMzSQ32.js";import{B as se}from"./badge-CAUv28Kt.js";import{D as B,a as F,b as P,c as U,d as oe}from"./dialog-B6MgW_kr.js";import{C as Se}from"./checkbox-C9VQct6S.js";import{c as Te,e as ze}from"./sendEmail-DvW3jg5m.js";import{C as De,a as Ee}from"./check-check-BWfsGuyA.js";import{A as _e}from"./arrow-right-DrZ7ft2P.js";import{P as K}from"./printer-DS8-KeDH.js";import{P as re}from"./plus-DKnNjOwn.js";import{F as q}from"./file-text-Bd3I4rsu.js";import{U as de}from"./users-ZvpR-rMZ.js";import{L as Y}from"./loader-circle-CwVPwZxj.js";import{E as Oe}from"./eye-KUbn11wo.js";import{P as X}from"./pen-line-BlEY8yzk.js";import{T as ke}from"./trash-2-oKJqgkeS.js";import{S as Ie}from"./search-BRgmdj2Y.js";import{R as Le}from"./rotate-ccw-jaflkToI.js";import"./index-lNCHZd04.js";import"./index-DhIDV8s9.js";import"./index-B8RviqSE.js";import"./index-7gvzw5oQ.js";import"./index-aI2jerDk.js";import"./index-B08KgGZw.js";import"./index-CZX9gHcB.js";import"./check-DgXwnz3F.js";const Me=[["path",{d:"m15 18-6-6 6-6",key:"1wnfg3"}]],$e=pe("chevron-left",Me);const Be=[["path",{d:"M14.106 5.553a2 2 0 0 0 1.788 0l3.659-1.83A1 1 0 0 1 21 4.619v12.764a1 1 0 0 1-.553.894l-4.553 2.277a2 2 0 0 1-1.788 0l-4.212-2.106a2 2 0 0 0-1.788 0l-3.659 1.83A1 1 0 0 1 3 19.381V6.618a1 1 0 0 1 .553-.894l4.553-2.277a2 2 0 0 1 1.788 0z",key:"169xi5"}],["path",{d:"M15 5.764v15",key:"1pn4in"}],["path",{d:"M9 3.236v15",key:"1uimfh"}]],Fe=pe("map",Be),ne=[{id:"centro_aeroporto",label:"Centro / Aeroporto",semana:"S1",dias:"Seg–Sex"},{id:"campinas",label:"Campinas e Região",semana:"S1",dias:"2 dias"},{id:"vila_mutirao",label:"Vila Mutirão / Curitiba / Balneário",semana:"S1",dias:"2 dias"},{id:"senador_canedo",label:"Senador Canedo + Bela Vista",semana:"S1",dias:"1 dia"},{id:"nova_veneza",label:"Nova Veneza + Nerópolis",semana:"S1",dias:"1 dia"},{id:"setor_bueno",label:"Setor Bueno + Oeste",semana:"S2",dias:"2 dias"},{id:"setor_sul",label:"Setor Sul",semana:"S2",dias:"1 dia"},{id:"trindade",label:"Trindade",semana:"S2",dias:"1 dia"},{id:"itaberai",label:"Itaberaí",semana:"S2",dias:"2 dias"},{id:"quirinopolis",label:"Quirinópolis + Itumbiara",semana:"S2",dias:"1 dia"},{id:"morrinhos",label:"Morrinhos + Catalão",semana:"S2",dias:"1 dia"},{id:"aparecida",label:"Aparecida de Goiânia",semana:"S3",dias:"2 dias"},{id:"caldas_novas",label:"Caldas Novas",semana:"S3",dias:"1 dia"},{id:"anapolis",label:"Anápolis",semana:"S3",dias:"1 dia"},{id:"abadia_guapo",label:"Abadia / Guapó / Aragoiânia",semana:"S3",dias:"1 dia"},{id:"ipora",label:"Iporá e Região",semana:"S3/S1",dias:"2 dias"},{id:"inhumas",label:"Inhumas / Goianira / Caturaí",semana:"S4",dias:"2 dias"},{id:"vera_cruz",label:"Vera Cruz / Parque Oeste / Santa Rita",semana:"S4",dias:"1 dia"},{id:"brasilia",label:"Brasília",semana:"01/07",dias:"2 dias"},{id:"rio_verde",label:"Rio Verde",semana:"Semanal",dias:"Seg/Qua/Sex"},{id:"veterinaria",label:"Veterinária Quinzenal",semana:"Quinzenal",dias:"1 dia"}],Pe={S1:"bg-blue-100 text-blue-800",S2:"bg-teal-100 text-teal-800",S3:"bg-amber-100 text-amber-800",S4:"bg-purple-100 text-purple-800","S3/S1":"bg-orange-100 text-orange-800","01/07":"bg-red-100 text-red-800",Semanal:"bg-green-100 text-green-800",Quinzenal:"bg-pink-100 text-pink-800"};function G(s){return s==="ativa"?{nome:"ATIVA COMERCIAL COMERCIO E SERVICOS LTDA",nomeAbrev:"ATIVA COMERCIAL",cnpj:"51.480.805/0001-10",endereco:"RUA JOSE GOMES BAYLAO, 793, CONJUNTO GUADALAJARA, Goiânia - GO, CEP 74423-500"}:{nome:"BIO LOGUS AMBIENTAL LTDA - ME",nomeAbrev:"BIO LOGUS AMBIENTAL EIRELI",cnpj:"26.484.921/0001-60",endereco:"RUA DOS FERROVIARIOS, QD 01, LT 05 — PARQUE INDUSTRIAL JOÃO BRÁS 2 — Goiânia - GO"}}function Ue(){const s=new Date().getFullYear(),r=Math.floor(1e4+Math.random()*9e4);return`${s}${r}`}function qe(s){const{numeroCDF:r,numeroMTR:b,dataEmissao:u,periodoInicio:f,periodoFim:l,cliente:o}=s,m=G(o.transportadora),y=u?new Date(u+"T12:00:00").toLocaleDateString("pt-BR"):new Date().toLocaleDateString("pt-BR"),C=f?new Date(f+"T12:00:00").toLocaleDateString("pt-BR"):y,j=l?new Date(l+"T12:00:00").toLocaleDateString("pt-BR"):y,S=`https://biologus-siger.vercel.app/verificar-cdf/${r}`;return`<!DOCTYPE html>
<html lang="pt-BR">
<head>
  <meta charset="utf-8"/>
  <title>CDF ${r}</title>
...
<div class="cdf-wrap">
  ...
  <div class="mtr-band">
    ...
    <div class="mtr-sep"></div>
    <span class="mtr-val" style="font-size:13px;color:#374151;font-family:'Inter',sans-serif;font-weight:500;">${y}</span>
  </div>
  ...
  <div class="body">
    ...
    <table class="rtable">
      ...
      <tbody>
        <tr>
          <td>
            <div style="font-weight:600;font-size:11.5px;margin-bottom:2px;">${m.nomeAbrev}</div>
            <div style="font-size:10px;color:#6b7280;">CNPJ: ${m.cnpj}</div>
          </td>
          <td>
...
<\/script>
...
</html>`}function le(s){const r=qe(s),b=new Blob([r],{type:"text/html;charset=utf-8"});return URL.createObjectURL(b)}function Ge(s,r){const b={};r.forEach(o=>{b[o.cliente.id]=o.cliente});const f=`<!DOCTYPE html><html><head><meta charset="utf-8"><title>MTRs em Lote</title><style>*{box-sizing:border-box;margin:0;padding:0}@media print{@page{margin:1cm;size:A4}}</style></head><body>${s.map((o,m)=>{const y=b[o.cliente_id]||{},C=o.data_emissao?new Date(o.data_emissao+"T12:00:00").toLocaleDateString("pt-BR"):"";return`<div style="${m<s.length-1?"page-break-after:always;":""}padding:20px;max-width:800px;margin:0 auto;font-family:Arial,sans-serif;font-size:11px;color:#000">
    ...
    </div>`}).join("")}</body></html>`,l=window.open("","_blank");if(!l){alert("Permita popups para este site e tente novamente");return}l.document.write(f),l.document.close(),l.focus(),setTimeout(()=>l.print(),600)}function Qe(s,r){const b=window.open("","_blank");if(!b)return;const u=new Date(s.data_emissao+"T12:00:00").toLocaleDateString("pt-BR");b.document.write(`<!DOCTYPE html><html><head><title>MTR ${s.numero}</title>
  <style>
    *{box-sizing:border-box;margin:0;padding:0}
  ...
  <div class="section">
    ...
    <div class="section-body">
      <div class="grid2">
        <div><div class="field-label">Nome</div><div class="field-value">${G(r.transportadora).nome}</div></div>
        ...
        <div style="grid-column:span 2"><div class="field-label">Endereço</div><div class="field-value">${G(r.transportadora).endereco}</div></div>
      </div>
    </div>
  </div>
  <div class="section">
  ...
  <script>window.onload=()=>window.print();<\/script>
  </body></html>`),b.document.close()}function ce({onSave:s,onCancel:r,titulo:b}){const u=w.useRef(null),f=w.useRef(!1),l=w.useRef(null),o=(c,v)=>{const g=v.getBoundingClientRect(),z=v.width/g.width,_=v.height/g.height;return"touches"in c?{x:(c.touches[0].clientX-g.left)*z,y:(c.touches[0].clientY-g.top)*_}:{x:(c.clientX-g.left)*z,y:(c.clientY-g.top)*_}},m=c=>{c.preventDefault();const v=u.current;v&&(f.current=!0,l.current=o(c,v))},y=c=>{if(c.preventDefault(),!f.current)return;const v=u.current,g=v?.getContext("2d");if(!v||!g||!l.current)return;const z=o(c,v);g.beginPath(),g.moveTo(l.current.x,l.current.y),g.lineTo(z.x,z.y),g.strokeStyle="#000",g.lineWidth=2.5,g.lineCap="round",g.lineJoin="round",g.stroke(),l.current=z},C=()=>{f.current=!1,l.current=null},j=()=>{const c=u.current,v=c?.getContext("2d");!c||!v||v.clearRect(0,0,c.width,c.height)},S=()=>{const c=u.current;c&&s(c.toDataURL("image/png"))};return e.jsxs("div",{className:"flex flex-col gap-3",children:[e.jsx("p",{className:"text-sm font-medium text-center",children:b}),e.jsx("div",{className:"border-2 border-dashed border-border rounded-lg bg-white touch-none",style:{touchAction:"none"},children:e.jsx("canvas",{ref:u,width:600,height:200,className:"w-full rounded-lg",style:{touchAction:"none"},onMouseDown:m,onMouseMove:y,onMouseUp:C,onMouseLeave:C,onTouchStart:m,onTouchMove:y,onTouchEnd:C})}),e.jsx("p",{className:"text-xs text-muted-foreground text-center",children:"Assine acima com o dedo ou caneta"}),e.jsxs("div",{className:"flex gap-2 justify-between",children:[e.jsxs(n,{variant:"outline",size:"sm",onClick:j,children:[e.jsx(Le,{className:"h-4 w-4 mr-1"})," Limpar"]}),e.jsxs("div",{className:"flex gap-2",children:[e.jsx(n,{variant:"ghost",size:"sm",onClick:r,children:"Cancelar"}),e.jsxs(n,{size:"sm",onClick:S,children:[e.jsx(X,{className:"h-4 w-4 mr-1"})," Salvar Assinatura"]})]})]})]})}function Ve({rota:s,dataSelecionada:r,onVoltar:b,user:u}){const f=Ne(),l=f,[o,m]=w.useState(!1),[y,C]=w.useState(""),[j,S]=w.useState([]),[c,v]=w.useState(!1),[g,z]=w.useState("GRUPO A, B, E INFECTANTES, QUIMICOS E PERFURO CORTANTES"),[_,xe]=w.useState("lista"),[D,O]=w.useState(null),[T,I]=w.useState(null),{data:p=[],isLoading:ue}=$({queryKey:["rota-clientes",s.id],queryFn:async()=>{const{data:a}=await N.from("rota_clientes").select("id, ordem, coletado, clientes(id, razao_social, nome_fantasia, logradouro, cidade, cnpj, latitude, longitude, transportadora)").eq("rota_codigo",s.id).order("ordem");return(a??[]).map(t=>({id:t.id,ordem:t.ordem,coletado:t.coletado??!1,cliente:t.clientes})).filter(t=>t.cliente)}}),{data:R=[]}=$({queryKey:["mtrs-rota",s.id,r],queryFn:async()=>{if(!p.length)return[];const{data:a}=await N.from("mtrs").select("id, numero, cliente_id, status, quantidade, unidade, data_emissao, descricao_residuo, acondicionamento, assinatura_gerador, assinatura_transportador, data_baixa").eq("rota_codigo",s.id).eq("data_emissao",r);return a??[]},enabled:p.length>0}),{data:fe=[]}=$({queryKey:["cdfs-rota",s.id,r],queryFn:async()=>{const{data:a}=await N.from("boletins_medicao").select("id, mtr_id, cdf_id, cdf_enviado, numero").in("mtr_id",R.map(t=>t.id));return a??[]},enabled:R.length>0}),{data:W=[]}=$({queryKey:["clientes-select"],queryFn:async()=>{const{data:a}=await N.from("clientes").select("id, razao_social, nome_fantasia, logradouro, cidade").eq("ativo",!0).order("razao_social",{ascending:!0});return a??[]}}),L=new Set(p.map(a=>a.cliente.id)),Q=E({mutationFn:async()=>{const a=j.map((i,d)=>({owner_id:u.id,rota_codigo:s.id,rota_id:null,cliente_id:i,ordem:p.length+d+1,frequencia:"semanal",coletado:!1})),{error:t}=await N.from("rota_clientes").upsert(a,{onConflict:"rota_codigo,cliente_id"});if(t)throw t},onSuccess:()=>{f.invalidateQueries({queryKey:["rota-clientes"]}),h.success(`${j.length} clientes adicionados`),m(!1),S([])},onError:a=>h.error(a.message)}),ge=E({mutationFn:async({mtrId:a,peso:t,cliente:i})=>{const d=new Date().toISOString().split("T")[0],x=Ue(),A=crypto.randomUUID(),{data:M,error:te}=await N.from("mtrs").update({status:"baixado",quantidade:t,data_baixa:d}).eq("id",a).select("id, numero, cliente_id, rota_codigo, descricao_residuo, unidade, data_emissao").single();if(te)throw te;const{data:we,error:ie}=await N.from("boletins_medicao").insert([{owner_id:u.id,mtr_id:M.id,cliente_id:M.cliente_id,data_coleta:d,peso_coletado:t,unidade:M.unidade||"kg",status:"pendente",pagamento_confirmado:!1,cdf_enviado:!1,cdf_id:A,numero:x}]).select("id").single();if(ie)throw ie;return{mtrData:M,boletimData:we,numeroCDF:x,cliente:i}},onSuccess:({mtrData:a,numeroCDF:t,cliente:i})=>{l.invalidateQueries({queryKey:["mtrs-rota"]}),l.invalidateQueries({queryKey:["cdfs-rota"]}),h.success("MTR baixado! Boletim e CDF gerados.");const d=new Date().toISOString().split("T")[0],x=le({numeroCDF:t,numeroMTR:a.numero,dataEmissao:d,periodoInicio:a.data_emissao||d,periodoFim:d,cliente:i});I({blobUrl:x,numeroCDF:t})},onError:a=>h.error(a.message)}),Z=E({mutationFn:async({mtrId:a,campo:t,dataUrl:i})=>{const{error:d}=await N.from("mtrs").update({[t]:i}).eq("id",a);if(d)throw d},onSuccess:()=>{l.invalidateQueries({queryKey:["mtrs-rota"]}),h.success("Assinatura salva!")}}),ve=E({mutationFn:async a=>{const{error:t}=await N.from("rota_clientes").delete().eq("id",a);if(t)throw t},onSuccess:()=>{f.invalidateQueries({queryKey:["rota-clientes"]}),h.success("Cliente removido")}}),be=E({mutationFn:async({rcId:a,coletado:t})=>{const{error:i}=await N.from("rota_clientes").update({coletado:t}).eq("id",a);if(i)throw i},onSuccess:()=>f.invalidateQueries({queryKey:["rota-clientes"]})}),ee=E({mutationFn:async({clienteId:a,ordem:t})=>{const i=`MTR-${r.replace(/-/g,"")}-${String(t).padStart(3,"0")}`,{error:d}=await N.from("mtrs").insert([{owner_id:u.id,cliente_id:a,numero:i,data_emissao:r,descricao_residuo:"GRUPO A, B, E INFECTANTES, QUIMICOS E PERFURO CORTANTES",quantidade:0,unidade:"kg",acondicionamento:"BOMBONA",status:"emitido",rota_codigo:s.id}]);if(d)throw d;return i},onSuccess:a=>{f.invalidateQueries({queryKey:["mtrs-rota"]}),h.success(`MTR ${a} gerado!`)},onError:a=>h.error(a.message)}),V=E({mutationFn:async()=>{const a=p.map((i,d)=>({owner_id:u.id,cliente_id:i.cliente.id,numero:`MTR-${r.replace(/-/g,"")}-${String(d+1).padStart(3,"0")}`,data_emissao:r,descricao_residuo:g,quantidade:0,unidade:"kg",acondicionamento:"BOMBONA",status:"emitido",rota_codigo:s.id})),{error:t}=await N.from("mtrs").insert(a);if(t)throw t},onSuccess:()=>{f.invalidateQueries({queryKey:["mtrs-rota"]}),f.invalidateQueries({queryKey:["mtrs"]}),h.success(`${p.length} MTRs criados!`),v(!1)},onError:a=>h.error(a.message)}),he=()=>{const a=window.open("","_blank");if(!a)return;const t=new Date(r+"T12:00:00").toLocaleDateString("pt-BR");a.document.write(`<!DOCTYPE html><html><head><title>Rota ${s.label}</title>
    <style>
    ...
    <h1>${s.label}</h1>
    <div class="sub">Data: ${t} · ${p.length} clientes · Semana ${s.semana}</div>
    <table>
      <thead><tr><th>#</th><th>Cliente</th><th>Endereço</th><th>MTR</th><th>Peso (kg)</th><th>Coletado</th></tr></thead>
      <tbody>
        ${p.map((i,d)=>{const x=R.find(A=>A.cliente_id===i.cliente.id);return`<tr>
            <td>${d+1}</td>
    ...
    <script>window.onload=()=>window.print();<\/script>
    </body></html>`),a.document.close()},ye=W.filter(a=>{const t=y.toLowerCase();return!t||(a.nome_fantasia||a.razao_social).toLowerCase().includes(t)||(a.cidade??"").toLowerCase().includes(t)}),J=p.filter(a=>a.coletado).length,ae=p.length>0?Math.round(J/p.length*100):0;return e.jsxs("div",{className:"space-y-4",children:[e.jsxs("div",{className:"flex items-center gap-3 flex-wrap",children:[e.jsxs(n,{variant:"ghost",size:"sm",onClick:b,children:[e.jsx($e,{className:"h-4 w-4 mr-1"})," Rotas"]}),e.jsxs("div",{className:"flex-1",children:[e.jsxs("h1",{className:"text-xl font-bold flex items-center gap-2",children:[e.jsx(Re,{className:"h-5 w-5 text-primary"}),s.label]}),e.jsxs("p",{className:"text-xs text-muted-foreground mt-0.5",children:[new Date(r+"T12:00:00").toLocaleDateString("pt-BR")," · Semana ",s.semana," · ",s.dias]})]}),e.jsxs("div",{className:"flex gap-2",children:[e.jsxs(n,{variant:"outline",size:"sm",onClick:he,children:[e.jsx(K,{className:"h-4 w-4 mr-1"})," Imprimir"]}),R.length>0&&e.jsxs(n,{variant:"outline",size:"sm",onClick:()=>Ge(R,p),children:[e.jsx(K,{className:"h-4 w-4 mr-1"})," MTRs em lote"]}),e.jsxs(n,{variant:"outline",size:"sm",onClick:()=>m(!0),children:[e.jsx(re,{className:"h-4 w-4 mr-1"})," Clientes"]}),e.jsxs(n,{size:"sm",onClick:()=>v(!0),disabled:p.length===0||R.length>0,children:[e.jsx(q,{className:"h-4 w-4 mr-1"}),R.length>0?`${R.length} MTRs emitidos`:"Gerar MTRs"]})]})]}),e.jsx("div",{className:"grid grid-cols-4 gap-3",children:[{label:"Clientes",val:p.length,color:"text-primary"},{label:"Coletados",val:J,color:"text-green-600"},{label:"Pendentes",val:p.length-J,color:"text-amber-600"},{label:"MTRs",val:R.length,color:"text-teal-600"}].map(a=>e.jsxs(k,{className:"p-3 text-center",children:[e.jsx("p",{className:`text-2xl font-bold ${a.color}`,children:a.val}),e.jsx("p",{className:"text-xs text-muted-foreground",children:a.label})]},a.label))}),p.length>0&&e.jsxs(k,{className:"p-3",children:[e.jsxs("div",{className:"flex justify-between text-sm mb-1.5",children:[e.jsx("span",{className:"text-muted-foreground",children:"Progresso da coleta"}),e.jsxs("span",{className:"font-bold text-primary",children:[ae,"%"]})]}),e.jsx("div",{className:"w-full bg-muted rounded-full h-2.5",children:e.jsx("div",{className:"bg-green-500 h-2.5 rounded-full transition-all",style:{width:`${ae}%`}})})]}),e.jsx("div",{className:"flex border-b",children:[{id:"lista",icon:de,label:"Lista"},{id:"mapa",icon:Fe,label:"Mapa"}].map(a=>e.jsxs("button",{onClick:()=>xe(a.id),className:`flex items-center gap-1.5 px-4 py-2 text-sm font-medium border-b-2 transition-colors ${_===a.id?"border-primary text-primary":"border-transparent text-muted-foreground"}`,children:[e.jsx(a.icon,{className:"h-4 w-4"}),a.label]},a.id))}),_==="lista"&&e.jsx(k,{children:ue?e.jsx("div",{className:"py-12 text-center",children:e.jsx(Y,{className:"h-5 w-5 animate-spin mx-auto text-muted-foreground"})}):p.length===0?e.jsxs("div",{className:"py-12 text-center",children:[e.jsx(de,{className:"h-10 w-10 mx-auto text-muted-foreground/30 mb-3"}),e.jsx("p",{className:"text-sm text-muted-foreground",children:"Nenhum cliente vinculado."}),e.jsxs(n,{size:"sm",className:"mt-3",onClick:()=>m(!0),children:[e.jsx(re,{className:"h-4 w-4 mr-1"})," Adicionar clientes"]})]}):e.jsx("div",{className:"divide-y",children:p.map((a,t)=>{const i=R.find(x=>x.cliente_id===a.cliente.id),d=fe.find(x=>x.mtr_id===i?.id);return e.jsxs("div",{className:`flex items-center gap-3 px-4 py-3 transition-colors ${a.coletado?"bg-green-50/50":""}`,children:[e.jsx("button",{onClick:()=>be.mutate({rcId:a.id,coletado:!a.coletado}),className:"flex-shrink-0",children:a.coletado?e.jsx(Ae,{className:"h-6 w-6 text-green-500"}):e.jsx(Ce,{className:"h-6 w-6 text-muted-foreground/30"})}),e.jsx("div",{className:`flex-shrink-0 w-7 h-7 rounded-full flex items-center justify-center text-xs font-bold ${a.coletado?"bg-green-500 text-white":"bg-primary text-white"}`,children:t+1}),e.jsxs("div",{className:"flex-1 min-w-0",children:[e.jsx("p",{className:`text-sm font-medium truncate ${a.coletado?"line-through text-muted-foreground":""}`,children:a.cliente.nome_fantasia||a.cliente.razao_social}),e.jsxs("p",{className:"text-xs text-muted-foreground truncate",children:[a.cliente.logradouro||"",a.cliente.cidade?` — ${a.cliente.cidade}`:""]})]}),e.jsxs("div",{className:"flex items-center gap-2 flex-shrink-0",children:[!i&&e.jsx(n,{variant:"ghost",size:"icon",className:"h-7 w-7",title:"Gerar MTR individual",onClick:()=>ee.mutate({clienteId:a.cliente.id,ordem:t+1}),disabled:ee.isPending,children:e.jsx(q,{className:"h-3.5 w-3.5 text-teal-600"})}),i&&e.jsxs(e.Fragment,{children:[e.jsx(se,{variant:i.status==="baixado"?"default":"secondary",className:`text-xs ${i.status==="baixado"?"bg-green-500":""}`,children:i.status==="baixado"?`${i.quantidade}kg ✓`:i.numero}),i.status!=="baixado"&&e.jsx(n,{variant:"ghost",size:"icon",className:"h-7 w-7",title:"Dar baixa no MTR",onClick:()=>{const x=window.prompt(`Peso coletado (kg) — ${a.cliente.nome_fantasia||a.cliente.razao_social}:`);if(x===null)return;const A=parseFloat(x.replace(",","."))||0;ge.mutate({mtrId:i.id,peso:A,cliente:a.cliente})},children:e.jsx(Ee,{className:"h-3.5 w-3.5 text-orange-500"})}),i.status==="baixado"&&d?.cdf_id&&e.jsx(n,{variant:"ghost",size:"icon",className:"h-7 w-7",title:`Visualizar CDF ${d.cdf_id}`,onClick:()=>{const x=new Date().toISOString().split("T")[0],A=le({numeroCDF:d.cdf_id??"",numeroMTR:i.numero,dataEmissao:i.data_emissao||x,periodoInicio:i.data_emissao||x,periodoFim:i.data_baixa||x,cliente:a.cliente});I({blobUrl:A,numeroCDF:d.cdf_id??""})},children:e.jsx(Oe,{className:"h-3.5 w-3.5 text-green-600"})}),e.jsx(n,{variant:"ghost",size:"icon",className:"h-7 w-7",title:"Assinar MTR",onClick:()=>O({mtr:i,cliente:a.cliente,etapa:"gerador"}),children:e.jsx(X,{className:`h-3.5 w-3.5 ${i.assinatura_gerador?"text-green-500":"text-muted-foreground"}`})}),e.jsx(n,{variant:"ghost",size:"icon",className:"h-7 w-7",title:"Imprimir MTR",onClick:()=>Qe(i,a.cliente),children:e.jsx(K,{className:"h-3.5 w-3.5 text-primary"})}),a.cliente.email&&e.jsx(n,{variant:"ghost",size:"icon",className:"h-7 w-7",title:"Enviar MTR por email",onClick:async()=>{const x=Te({clienteNome:a.cliente.nome_fantasia||a.cliente.razao_social,numeroMTR:i.numero,dataEmissao:i.data_emissao?new Date(i.data_emissao+"T12:00:00").toLocaleDateString("pt-BR"):"—",residuo:i.descricao_residuo||"GRUPO A, B, E"});h.loading("Enviando MTR...");const A=await ze({tipo:"mtr",para:a.cliente.email,...x});h.dismiss(),A.success?h.success("MTR enviado por email!"):h.error(A.error)},children:e.jsx(Send,{className:"h-3.5 w-3.5 text-blue-500"})})]}),e.jsx(n,{variant:"ghost",size:"icon",className:"h-7 w-7",onClick:()=>ve.mutate(a.id),children:e.jsx(ke,{className:"h-3.5 w-3.5 text-muted-foreground"})})]})]},a.id)})})}),_==="mapa"&&e.jsxs(k,{className:"overflow-hidden",children:[e.jsx("div",{id:"mapa-rota",style:{height:420}}),e.jsx("script",{dangerouslySetInnerHTML:{__html:`
            if (typeof L !== 'undefined') {
              const map = L.map('mapa-rota').setView([-16.686, -49.264], 11);
              L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {attribution: '© OSM'}).addTo(map);
              const clientes = ${JSON.stringify(p.filter(a=>a.cliente.latitude).map((a,t)=>({lat:a.cliente.latitude,lng:a.cliente.longitude,nome:a.cliente.nome_fantasia||a.cliente.razao_social,coletado:a.coletado,ordem:t+1})))};
              clientes.forEach(c => {
          ...
          `}})]}),e.jsx(B,{open:o,onOpenChange:m,children:e.jsxs(F,{className:"max-w-lg max-h-[90vh] overflow-hidden flex flex-col",children:[e.jsx(P,{children:e.jsxs(U,{children:["Adicionar clientes — ",s.label]})}),e.jsxs("div",{className:"space-y-3 flex-1 overflow-hidden flex flex-col",children:[e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsxs("span",{className:"text-sm text-muted-foreground",children:[j.length," selecionado(s)"]}),e.jsxs("div",{className:"flex gap-2",children:[e.jsx(n,{size:"sm",variant:"outline",onClick:()=>S(W.map(a=>a.id)),children:"Todos"}),e.jsx(n,{size:"sm",variant:"outline",onClick:()=>S([]),children:"Limpar"})]})]}),e.jsxs("div",{className:"relative",children:[e.jsx(Ie,{className:"absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-muted-foreground"}),e.jsx(H,{placeholder:"Buscar por nome ou cidade...",value:y,onChange:a=>C(a.target.value),className:"pl-9"})]}),e.jsx("div",{className:"flex-1 overflow-y-auto border rounded-md divide-y",children:ye.map(a=>e.jsxs("div",{className:`flex items-center gap-3 px-3 py-2.5 cursor-pointer hover:bg-muted/50 ${L.has(a.id)?"opacity-50":""}`,onClick:()=>{L.has(a.id)||S(t=>t.includes(a.id)?t.filter(i=>i!==a.id):[...t,a.id])},children:[e.jsx(Se,{checked:j.includes(a.id)||L.has(a.id)}),e.jsxs("div",{className:"flex-1 min-w-0",children:[e.jsx("p",{className:"text-sm font-medium truncate",children:a.nome_fantasia||a.razao_social}),e.jsx("p",{className:"text-xs text-muted-foreground",children:a.cidade})]}),L.has(a.id)&&e.jsx(se,{variant:"secondary",className:"text-xs flex-shrink-0",children:"Já na rota"})]},a.id))})]}),e.jsxs(oe,{children:[e.jsx(n,{variant:"ghost",onClick:()=>{m(!1),S([])},children:"Cancelar"}),e.jsxs(n,{onClick:()=>Q.mutate(),disabled:Q.isPending||j.length===0,children:[Q.isPending&&e.jsx(Y,{className:"h-4 w-4 mr-2 animate-spin"}),"Adicionar ",j.length>0?j.length:""," clientes"]})]})]})}),e.jsx(B,{open:!!D,onOpenChange:a=>!a&&O(null),children:e.jsxs(F,{className:"max-w-lg",children:[e.jsx(P,{children:e.jsxs(U,{className:"flex items-center gap-2",children:[e.jsx(X,{className:"h-5 w-5 text-primary"}),"Assinatura Digital — MTR ",D?.mtr?.numero]})}),D&&e.jsx("div",{className:"space-y-4",children:D.etapa==="gerador"?e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"bg-muted/50 rounded-md p-3 text-sm",children:[e.jsx("p",{className:"font-medium",children:D.cliente.nome_fantasia||D.cliente.razao_social}),e.jsx("p",{className:"text-muted-foreground text-xs mt-0.5",children:"Gerador — assine como responsável pelo resíduo"})]}),e.jsx(ce,{titulo:"Assinatura do Gerador",onCancel:()=>O(null),onSave:a=>{Z.mutate({mtrId:D.mtr.id,campo:"assinatura_gerador",dataUrl:a}),O(t=>t?{...t,etapa:"transportador"}:null)}})]}):e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"bg-muted/50 rounded-md p-3 text-sm",children:[e.jsx("p",{className:"font-medium",children:"BIO LOGUS AMBIENTAL LTDA - ME"}),e.jsx("p",{className:"text-muted-foreground text-xs mt-0.5",children:"Transportador — assine como responsável pela coleta"})]}),e.jsx(ce,{titulo:"Assinatura do Transportador",onCancel:()=>O(null),onSave:a=>{Z.mutate({mtrId:D.mtr.id,campo:"assinatura_transportador",dataUrl:a}),O(null),h.success("MTR assinado com sucesso!")}})]})})]})}),e.jsx(B,{open:!!T,onOpenChange:a=>{!a&&T?.blobUrl&&URL.revokeObjectURL(T.blobUrl),a||I(null)},children:e.jsxs(F,{className:"max-w-4xl w-full h-[90vh] flex flex-col p-0 gap-0",children:[e.jsx(P,{className:"px-6 py-4 border-b flex-shrink-0",children:e.jsxs(U,{className:"flex items-center gap-2",children:[e.jsx(q,{className:"h-5 w-5 text-green-600"}),"Certificado de Destinação Final — Nº ",T?.numeroCDF]})}),e.jsx("div",{className:"flex-1 overflow-hidden",children:T&&e.jsx("iframe",{src:T.blobUrl,className:"w-full h-full border-0",title:`CDF ${T.numeroCDF}`})}),e.jsxs("div",{className:"px-6 py-3 border-t flex-shrink-0 flex justify-between items-center bg-muted/30",children:[e.jsx("p",{className:"text-xs text-muted-foreground",children:'Use o botão "Imprimir / Salvar PDF" dentro do documento para exportar'}),e.jsx(n,{variant:"outline",size:"sm",onClick:()=>{T?.blobUrl&&URL.revokeObjectURL(T.blobUrl),I(null)},children:"Fechar"})]})]})}),e.jsx(B,{open:c,onOpenChange:v,children:e.jsxs(F,{className:"max-w-md",children:[e.jsx(P,{children:e.jsxs(U,{className:"flex items-center gap-2",children:[e.jsx(q,{className:"h-5 w-5 text-primary"}),"Gerar ",p.length," MTRs em lote"]})}),e.jsxs("div",{className:"space-y-4 py-2",children:[e.jsxs("p",{className:"text-sm text-muted-foreground",children:["Será gerado 1 MTR para cada cliente da rota com a data ",e.jsx("strong",{children:new Date(r+"T12:00:00").toLocaleDateString("pt-BR")}),"."]}),e.jsxs("div",{className:"space-y-1.5",children:[e.jsx(me,{children:"Descrição do resíduo"}),e.jsx(H,{value:g,onChange:a=>z(a.target.value)})]}),e.jsxs("div",{className:"bg-muted/50 rounded-md p-3 text-sm",children:[e.jsx("p",{className:"font-medium",children:"Numeração automática:"}),e.jsxs("p",{className:"text-muted-foreground text-xs mt-0.5",children:["MTR-",r.replace(/-/g,""),"-001 até -",String(p.length).padStart(3,"0")]})]})]}),e.jsxs(oe,{children:[e.jsx(n,{variant:"ghost",onClick:()=>v(!1),children:"Cancelar"}),e.jsxs(n,{onClick:()=>V.mutate(),disabled:V.isPending,children:[V.isPending&&e.jsx(Y,{className:"h-4 w-4 mr-2 animate-spin"}),"Gerar MTRs"]})]})]})})]})}function ha(){const{user:s}=je.useRouteContext(),[r,b]=w.useState(()=>new Date().toISOString().slice(0,10)),[u,f]=w.useState(null),l=[...new Set(ne.map(o=>o.semana))];return u?e.jsx(Ve,{rota:u,dataSelecionada:r,onVoltar:()=>f(null),user:s}):e.jsxs("div",{className:"space-y-6",children:[e.jsxs("div",{className:"flex items-start justify-between flex-wrap gap-4",children:[e.jsxs("div",{children:[e.jsxs("h1",{className:"text-2xl font-bold flex items-center gap-2",children:[e.jsx(De,{className:"h-6 w-6 text-primary"})," Agendamento de Rotas"]}),e.jsx("p",{className:"text-sm text-muted-foreground mt-1",children:"Selecione a rota para visualizar clientes, gerar MTRs e registrar coletas."})]}),e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(me,{className:"text-sm whitespace-nowrap",children:"Data:"}),e.jsx(H,{type:"date",value:r,onChange:o=>b(o.target.value),className:"w-40"})]})]}),l.map(o=>e.jsxs("div",{children:[e.jsxs("div",{className:"flex items-center gap-2 mb-3",children:[e.jsx("span",{className:`text-xs font-semibold px-2 py-0.5 rounded-full ${Pe[o]??"bg-gray-100 text-gray-800"}`,children:o}),e.jsxs("span",{className:"text-sm text-muted-foreground",children:["Semana ",o]})]}),e.jsx("div",{className:"grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3",children:ne.filter(m=>m.semana===o).map(m=>e.jsx(k,{onClick:()=>f(m),className:"p-4 cursor-pointer transition-all border-2 border-border hover:border-primary hover:shadow-md group",children:e.jsxs("div",{className:"flex items-start justify-between gap-2",children:[e.jsxs("div",{className:"flex-1",children:[e.jsx("p",{className:"font-medium text-sm group-hover:text-primary transition-colors",children:m.label}),e.jsx("p",{className:"text-xs text-muted-foreground mt-0.5",children:m.dias})]}),e.jsx(_e,{className:"h-4 w-4 text-muted-foreground/40 group-hover:text-primary transition-colors mt-0.5"})]})},m.id))})]},o))]})}export{ha as component};
