import{d as ve,m as _e,a6 as De,r as x,n as pe,s as k,o as ee,t as h,j as e,i as P,I as K,B as i,K as j,C as ae,a as xe,y as Se}from"./index-C9_2v7pz.js";import{L as $}from"./label-BHMzSQ32.js";import{D as R,a as z,b as T,c as q,d as M}from"./dialog-B6MgW_kr.js";import{T as ke,a as Ee,b as ue,c as E,d as Fe,e as F}from"./table-BzF6jKcI.js";import{S as Re,a as ze,d as Te,b as qe,c as Ae}from"./select-4Jyqvbsl.js";import{a as Le,b as Pe}from"./sendEmail-DvW3jg5m.js";import{P as Oe}from"./plus-DKnNjOwn.js";import{F as O}from"./file-check-PG31Mewn.js";import{D as B}from"./dollar-sign-BXiTqhXX.js";import{L as fe}from"./loader-circle-CwVPwZxj.js";import{E as ge}from"./eye-KUbn11wo.js";import{F as U}from"./file-text-Bd3I4rsu.js";import"./index-lNCHZd04.js";import"./index-DhIDV8s9.js";import"./index-B8RviqSE.js";import"./index-7gvzw5oQ.js";import"./index-aI2jerDk.js";import"./index-eZgJSIqH.js";import"./index-CZX9gHcB.js";import"./index-mcEMciqf.js";import"./index-CJL45VUn.js";import"./index-B08KgGZw.js";import"./check-DgXwnz3F.js";const Be=[["rect",{width:"8",height:"4",x:"8",y:"2",rx:"1",ry:"1",key:"tgr4d6"}],["path",{d:"M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2",key:"116196"}],["path",{d:"m9 14 2 2 4-4",key:"df797q"}]],Ie=ve("clipboard-check",Be);const $e=[["path",{d:"M21 21H8a2 2 0 0 1-1.42-.587l-3.994-3.999a2 2 0 0 1 0-2.828l10-10a2 2 0 0 1 2.829 0l5.999 6a2 2 0 0 1 0 2.828L12.834 21",key:"g5wo59"}],["path",{d:"m5.082 11.09 8.828 8.828",key:"1wx5vj"}]],Me=ve("eraser",$e),I={pendente:{label:"Pendente",color:"bg-gray-100 text-gray-700"},coletado:{label:"Coletado",color:"bg-blue-100 text-blue-800"},pago:{label:"Pago",color:"bg-green-100 text-green-800"},cdf_emitido:{label:"CDF Emitido",color:"bg-teal-100 text-teal-800"},cdf_enviado:{label:"CDF Enviado ✓",color:"bg-emerald-100 text-emerald-800"}};function Ue(p){const{numeroCDF:d,numeroMTR:f,dataEmissao:g,periodoInicio:s,periodoFim:u,peso:m,unidade:b,cliente:n}=p,t=r=>r?new Date(r+"T12:00:00").toLocaleDateString("pt-BR"):"—",l=`https://biologus-siger.vercel.app/verificar-cdf/${d}`;return`<!DOCTYPE html>
<html lang="pt-BR">
<head>
  <meta charset="utf-8"/>
  <title>CDF ${d}</title>
...
Biologus Ambiental
(62) 3558-2791`),v=y?`https://wa.me/55${y}?text=${C}`:`https://wa.me/?text=${C}`;window.open(v,"_blank"),h.success("CDF marcado como enviado via WhatsApp"),t(null)},ye=async a=>{await X(a);const o=a.clientes?.nome_fantasia||a.clientes?.razao_social||"",c=a.numero||a.cdf_id||"",y=a.clientes?.email||"",C=encodeURIComponent(`Certificado de Destinação Final Nº ${c} - Biologus Ambiental`),v=encodeURIComponent(`Prezado(a) ${o},
...
Biologus Ambiental
(62) 3558-2791
comercial@biologusambiental.com.br`);window.open(`mailto:${y}?subject=${C}&body=${v}`,"_blank"),h.success("CDF marcado como enviado via E-mail"),t(null)},Z=ee({mutationFn:async a=>{t(a)},onError:a=>h.error(a.message)}),V={total:D.length,coletados:D.filter(a=>a.status==="cdf_emitido").length,aguardandoPagamento:D.filter(a=>!a.pagamento_confirmado&&a.status!=="cdf_enviado").length,enviados:D.filter(a=>a.cdf_enviado).length};return e.jsxs("div",{className:"space-y-6",children:[e.jsxs("div",{className:"flex items-start justify-between flex-wrap gap-4",children:[e.jsxs("div",{children:[e.jsxs("h1",{className:"text-2xl font-bold text-foreground flex items-center gap-2",children:[e.jsx(P,{className:"h-6 w-6 text-primary"})," Boletim de Medição"]}),e.jsx("p",{className:"text-sm text-muted-foreground mt-1",children:"Registre o peso coletado e a assinatura do cliente. O CDF é gerado automaticamente."})]}),e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx(K,{type:"date",value:G,onChange:a=>be(a.target.value),className:"w-40"}),e.jsxs(i,{onClick:()=>g(!0),disabled:H.length===0,children:[e.jsx(Oe,{className:"h-4 w-4 mr-1"})," Nova coleta"]})]})]}),e.jsx("div",{className:"grid grid-cols-2 lg:grid-cols-4 gap-4",children:[{label:"Total do dia",val:V.total,icon:Ie,color:"text-primary"},{label:"CDF gerado",val:V.coletados,icon:O,color:"text-teal-600"},{label:"Aguard. pagamento",val:V.aguardandoPagamento,icon:B,color:"text-amber-600"},{label:"CDF enviado",val:V.enviados,icon:j,color:"text-emerald-600"}].map(a=>e.jsx(ae,{className:"p-4",children:e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsxs("div",{children:[e.jsx("p",{className:"text-2xl font-bold",children:a.val}),e.jsx("p",{className:"text-xs text-muted-foreground mt-0.5",children:a.label})]}),e.jsx(a.icon,{className:`h-6 w-6 ${a.color}`})]})},a.label))}),e.jsx(ae,{className:"p-4 bg-muted/30",children:e.jsxs("div",{className:"flex items-center gap-2 flex-wrap text-xs text-muted-foreground",children:[e.jsxs("span",{className:"flex items-center gap-1 font-medium text-foreground",children:[e.jsx(P,{className:"h-3.5 w-3.5 text-blue-500"})," Peso + Assinatura"]}),e.jsx("span",{children:"→"}),e.jsxs("span",{className:"flex items-center gap-1 font-medium text-foreground",children:[e.jsx(O,{className:"h-3.5 w-3.5 text-teal-500"})," CDF gerado auto"]}),e.jsx("span",{children:"→"}),e.jsxs("span",{className:"flex items-center gap-1 font-medium text-foreground",children:[e.jsx(B,{className:"h-3.5 w-3.5 text-amber-500"})," Confirmar pagamento"]}),e.jsx("span",{children:"→"}),e.jsxs("span",{className:"flex items-center gap-1 font-medium text-foreground",children:[e.jsx(j,{className:"h-3.5 w-3.5 text-emerald-500"})," Enviar CDF ao cliente"]})]})}),e.jsx("div",{className:"flex gap-2 flex-wrap",children:["todos","cdf_emitido","pago","cdf_enviado"].map(a=>e.jsx("button",{onClick:()=>Q(a),className:`text-xs px-3 py-1.5 rounded-full border transition-colors ${N===a?"bg-primary text-primary-foreground border-primary":"border-border text-muted-foreground hover:border-primary/40"}`,children:a==="todos"?`Todos (${D.length})`:I[a]?.label},a))}),e.jsx(ae,{children:Ne?e.jsx("div",{className:"py-16 text-center",children:e.jsx(fe,{className:"h-6 w-6 mx-auto animate-spin text-muted-foreground"})}):ce.length===0?e.jsxs("div",{className:"py-16 text-center",children:[e.jsx(P,{className:"h-10 w-10 mx-auto text-muted-foreground/30 mb-3"}),e.jsx("p",{className:"text-sm text-muted-foreground",children:"Nenhum boletim para esta data."})]}):e.jsxs(ke,{children:[e.jsx(Ee,{children:e.jsxs(ue,{children:[e.jsx(E,{children:"Cliente"}),e.jsx(E,{children:"MTR"}),e.jsx(E,{children:"Peso"}),e.jsx(E,{children:"Assinatura"}),e.jsx(E,{children:"Status"}),e.jsx(E,{className:"text-right",children:"Ações"})]})}),e.jsx(Fe,{children:ce.map(a=>e.jsxs(ue,{children:[e.jsx(F,{className:"font-medium text-sm",children:a.clientes?.nome_fantasia||a.clientes?.razao_social||"—"}),e.jsx(F,{className:"text-sm text-muted-foreground",children:a.mtrs?.numero??"—"}),e.jsxs(F,{className:"text-sm font-semibold",children:[a.peso_coletado," ",a.unidade]}),e.jsx(F,{children:a.assinatura_cliente?e.jsxs("span",{className:"flex items-center gap-1 text-xs text-green-600",children:[e.jsx(xe,{className:"h-3.5 w-3.5"})," Assinado"]}):e.jsx("span",{className:"text-xs text-muted-foreground",children:"Sem assinatura"})}),e.jsx(F,{children:e.jsx("span",{className:`text-xs px-2 py-0.5 rounded-full font-medium ${I[a.status]?.color??"bg-gray-100 text-gray-700"}`,children:I[a.status]?.label??a.status})}),e.jsx(F,{children:e.jsxs("div",{className:"flex items-center justify-end gap-1",children:[e.jsx(i,{variant:"ghost",size:"icon",className:"h-8 w-8",onClick:()=>u(a),children:e.jsx(ge,{className:"h-4 w-4"})}),!a.pagamento_confirmado&&e.jsxs(i,{size:"sm",variant:"outline",className:"h-8 text-xs gap-1 text-amber-700 border-amber-300 hover:bg-amber-50",onClick:()=>Y.mutate(a.id),disabled:Y.isPending,children:[e.jsx(B,{className:"h-3.5 w-3.5"})," Confirmar pgto"]}),e.jsxs(i,{size:"sm",variant:"outline",className:"h-8 text-xs gap-1 text-teal-700 border-teal-300 hover:bg-teal-50",onClick:()=>de(a),children:[e.jsx(O,{className:"h-3.5 w-3.5"})," Ver CDF"]}),e.jsxs(i,{size:"sm",variant:"outline",className:"h-8 text-xs gap-1 text-blue-700 border-blue-300 hover:bg-blue-50",onClick:()=>r(a),children:[e.jsx(U,{className:"h-3.5 w-3.5"})," NFS-e"]}),a.pagamento_confirmado&&!a.cdf_enviado&&e.jsxs(i,{size:"sm",className:"h-8 text-xs gap-1",onClick:()=>Z.mutate(a),disabled:Z.isPending,children:[e.jsx(j,{className:"h-3.5 w-3.5"})," Enviar CDF"]})]})})]},a.id))})]})}),e.jsx(R,{open:f,onOpenChange:g,children:e.jsxs(z,{className:"max-w-lg max-h-[90vh] overflow-y-auto",children:[e.jsx(T,{children:e.jsxs(q,{className:"flex items-center gap-2",children:[e.jsx(P,{className:"h-5 w-5 text-primary"})," Registrar Coleta"]})}),e.jsxs("div",{className:"space-y-5 py-2",children:[e.jsxs("div",{className:"space-y-1.5",children:[e.jsx($,{children:"MTR *"}),e.jsxs(Re,{onValueChange:a=>se(H.find(o=>o.id===a)??null),children:[e.jsx(ze,{children:e.jsx(Te,{placeholder:"Selecione o MTR"})}),e.jsx(qe,{children:H.map(a=>e.jsxs(Ae,{value:a.id,children:[a.numero," — ",a.clientes?.nome_fantasia||a.clientes?.razao_social]},a.id))})]}),w&&e.jsxs("div",{className:"bg-muted/50 rounded-md p-3 text-xs space-y-1",children:[e.jsxs("p",{children:[e.jsx("span",{className:"text-muted-foreground",children:"Resíduo:"})," ",w.descricao_residuo]}),e.jsxs("p",{children:[e.jsx("span",{className:"text-muted-foreground",children:"Cliente:"})," ",w.clientes?.nome_fantasia||w.clientes?.razao_social]})]})]}),e.jsxs("div",{className:"space-y-1.5",children:[e.jsx($,{children:"Peso coletado (kg) *"}),e.jsxs("div",{className:"flex gap-2 items-center",children:[e.jsx(K,{type:"number",step:"0.001",min:"0",placeholder:"0.000",value:A,onChange:a=>te(a.target.value),className:"text-lg font-semibold"}),e.jsx("span",{className:"text-sm text-muted-foreground",children:"kg"})]})]}),e.jsxs("div",{className:"space-y-1.5",children:[e.jsx($,{children:"Nome do responsável (opcional)"}),e.jsx(K,{placeholder:"Quem assinou no cliente",value:oe,onChange:a=>ie(a.target.value)})]}),e.jsx(Ve,{onChange:le}),e.jsxs("div",{className:"space-y-1.5",children:[e.jsx($,{children:"Observações (opcional)"}),e.jsx(K,{placeholder:"Ex: embalagem danificada...",value:ne,onChange:a=>re(a.target.value)})]}),e.jsxs("div",{className:"bg-teal-50 border border-teal-200 rounded-md p-3 text-xs text-teal-800 flex items-start gap-2",children:[e.jsx(O,{className:"h-4 w-4 mt-0.5 flex-shrink-0"}),e.jsxs("div",{children:[e.jsx("p",{className:"font-medium",children:"CDF gerado automaticamente"}),e.jsx("p",{className:"mt-0.5 opacity-80",children:"O certificado fica disponível para visualização imediatamente após o registro."})]})]})]}),e.jsxs(M,{children:[e.jsx(i,{variant:"ghost",onClick:()=>g(!1),children:"Cancelar"}),e.jsxs(i,{onClick:()=>W.mutate(),disabled:W.isPending||!w||!A,children:[W.isPending&&e.jsx(fe,{className:"h-4 w-4 mr-2 animate-spin"}),e.jsx(P,{className:"h-4 w-4 mr-2"})," Registrar coleta"]})]})]})}),s&&e.jsx(R,{open:!!s,onOpenChange:()=>u(null),children:e.jsxs(z,{className:"max-w-lg max-h-[90vh] overflow-y-auto",children:[e.jsx(T,{children:e.jsx(q,{children:"Boletim de Medição"})}),e.jsxs("div",{className:"space-y-4 py-2",children:[e.jsxs("div",{className:"grid grid-cols-2 gap-3 text-sm",children:[e.jsxs("div",{children:[e.jsx("p",{className:"text-xs text-muted-foreground",children:"Cliente"}),e.jsx("p",{className:"font-medium",children:s.clientes?.nome_fantasia||s.clientes?.razao_social})]}),e.jsxs("div",{children:[e.jsx("p",{className:"text-xs text-muted-foreground",children:"MTR"}),e.jsx("p",{className:"font-medium",children:s.mtrs?.numero})]}),e.jsxs("div",{children:[e.jsx("p",{className:"text-xs text-muted-foreground",children:"Data"}),e.jsx("p",{className:"font-medium",children:new Date(s.data_coleta+"T12:00:00").toLocaleDateString("pt-BR")})]}),e.jsxs("div",{children:[e.jsx("p",{className:"text-xs text-muted-foreground",children:"Peso"}),e.jsxs("p",{className:"font-bold text-primary",children:[s.peso_coletado," ",s.unidade]})]}),e.jsxs("div",{children:[e.jsx("p",{className:"text-xs text-muted-foreground",children:"Responsável"}),e.jsx("p",{className:"font-medium",children:s.nome_responsavel||"—"})]}),e.jsxs("div",{children:[e.jsx("p",{className:"text-xs text-muted-foreground",children:"Status"}),e.jsx("span",{className:`text-xs px-2 py-0.5 rounded-full font-medium ${I[s.status]?.color}`,children:I[s.status]?.label})]})]}),s.assinatura_cliente&&e.jsxs("div",{children:[e.jsx("p",{className:"text-xs text-muted-foreground mb-1",children:"Assinatura do cliente"}),e.jsx("div",{className:"border rounded-md p-2 bg-white",children:e.jsx("img",{src:s.assinatura_cliente,alt:"Assinatura",className:"max-h-24 w-full object-contain"})})]}),s.observacoes&&e.jsxs("div",{children:[e.jsx("p",{className:"text-xs text-muted-foreground",children:"Observações"}),e.jsx("p",{className:"text-sm",children:s.observacoes})]}),e.jsxs("div",{className:"border-t pt-4 space-y-2",children:[e.jsx("p",{className:"text-xs font-medium text-muted-foreground uppercase tracking-wide",children:"Status do pagamento"}),s.pagamento_confirmado?e.jsxs("p",{className:"text-sm text-green-600 flex items-center gap-1",children:[e.jsx(xe,{className:"h-4 w-4"})," Pagamento confirmado"]}):e.jsxs("p",{className:"text-sm text-amber-600 flex items-center gap-1",children:[e.jsx(B,{className:"h-4 w-4"})," Aguardando pagamento"]}),s.cdf_enviado?e.jsxs("p",{className:"text-sm text-emerald-600 flex items-center gap-1",children:[e.jsx(j,{className:"h-4 w-4"})," CDF enviado em ",s.data_envio_cdf?new Date(s.data_envio_cdf).toLocaleDateString("pt-BR"):"—"]}):e.jsxs("p",{className:"text-sm text-muted-foreground flex items-center gap-1",children:[e.jsx(Se,{className:"h-4 w-4"})," CDF ainda não enviado"]})]})]}),e.jsxs(M,{children:[!s.pagamento_confirmado&&e.jsxs(i,{variant:"outline",className:"text-amber-700 border-amber-300",onClick:()=>{Y.mutate(s.id),u(null)},children:[e.jsx(B,{className:"h-4 w-4 mr-1"})," Confirmar pagamento"]}),(s.cdf_id||s.numero||s.mtrs?.numero)&&e.jsxs(i,{variant:"outline",onClick:()=>{de(s),u(null)},children:[e.jsx(ge,{className:"h-4 w-4 mr-1"})," Visualizar CDF"]}),s.pagamento_confirmado&&!s.cdf_enviado&&e.jsxs(i,{onClick:()=>{Z.mutate(s),u(null)},children:[e.jsx(j,{className:"h-4 w-4 mr-1"})," Enviar CDF"]}),e.jsx(i,{variant:"ghost",onClick:()=>u(null),children:"Fechar"})]})]})}),e.jsx(R,{open:!!m,onOpenChange:a=>{!a&&m?.blobUrl&&URL.revokeObjectURL(m.blobUrl),a||b(null)},children:e.jsxs(z,{className:"max-w-4xl w-full h-[90vh] flex flex-col p-0 gap-0",children:[e.jsx(T,{className:"px-6 py-4 border-b flex-shrink-0",children:e.jsxs(q,{className:"flex items-center gap-2",children:[e.jsx(O,{className:"h-5 w-5 text-green-600"}),"Certificado de Destinação Final — Nº ",m?.numeroCDF]})}),e.jsx("div",{className:"flex-1 overflow-hidden",children:m&&e.jsx("iframe",{src:m.blobUrl,className:"w-full h-full border-0",title:`CDF ${m.numeroCDF}`})}),e.jsxs("div",{className:"px-6 py-3 border-t flex-shrink-0 flex justify-between items-center bg-muted/30",children:[e.jsx("p",{className:"text-xs text-muted-foreground",children:'Use o botão "Imprimir / Salvar PDF" dentro do documento para exportar'}),e.jsx(i,{variant:"outline",size:"sm",onClick:()=>{m?.blobUrl&&URL.revokeObjectURL(m.blobUrl),b(null)},children:"Fechar"})]})]})}),n&&e.jsx(R,{open:!!n,onOpenChange:a=>!a&&t(null),children:e.jsxs(z,{className:"max-w-sm",children:[e.jsx(T,{children:e.jsxs(q,{className:"flex items-center gap-2",children:[e.jsx(j,{className:"h-5 w-5 text-primary"}),"Enviar CDF — ",n.numero||n.cdf_id]})}),e.jsxs("div",{className:"space-y-3 py-2",children:[e.jsxs("p",{className:"text-sm text-muted-foreground",children:["Cliente: ",e.jsx("strong",{children:n.clientes?.nome_fantasia||n.clientes?.razao_social})]}),e.jsx("p",{className:"text-xs text-muted-foreground",children:"Escolha como enviar o certificado:"}),e.jsxs("div",{className:"grid gap-3",children:[e.jsxs(i,{className:"w-full gap-2 bg-green-500 hover:bg-green-600",onClick:()=>we(n),children:[e.jsx(j,{className:"h-4 w-4"}),"Enviar por WhatsApp",n.clientes?.telefone&&e.jsxs("span",{className:"text-xs opacity-80",children:["(",n.clientes.telefone,")"]})]}),e.jsxs(i,{variant:"outline",className:"w-full gap-2",onClick:()=>me(n,"cdf"),children:[e.jsx(j,{className:"h-4 w-4"}),"Enviar CDF por E-mail",n.clientes?.email&&e.jsxs("span",{className:"text-xs text-muted-foreground",children:["(",n.clientes.email,")"]})]}),e.jsxs(i,{variant:"outline",className:"w-full gap-2",onClick:()=>me(n,"nfse"),children:[e.jsx(U,{className:"h-4 w-4"}),"Enviar NFS-e por E-mail",n.clientes?.email&&e.jsxs("span",{className:"text-xs text-muted-foreground",children:["(",n.clientes.email,")"]})]})]})]}),e.jsx(M,{children:e.jsx(i,{variant:"ghost",onClick:()=>t(null),children:"Cancelar"})})]})}),l&&(()=>{const a=l,o=Ge(a.clientes?.transportadora),c=he(a.peso_coletado,{valor_franquia:a.clientes?.valor_franquia,peso_franquia:a.clientes?.peso_franquia,valor_kg_excedente:a.clientes?.valor_kg_excedente}),C=`COLETA, TRANSPORTE, TRATAMENTO E DESTINACAO DE RESIDUOS PERIGOSOS REFERENTE AO MES DE ${new Date(a.data_coleta+"T12:00:00").toLocaleDateString("pt-BR",{month:"long",year:"numeric"}).toUpperCase()}`,v=_=>_.toLocaleString("pt-BR",{style:"currency",currency:"BRL"}),L=c.valorTotal*o.aliquotaISSQN/100,J=_=>{navigator.clipboard.writeText(_),h.success("Copiado!")};return e.jsx(R,{open:!!l,onOpenChange:_=>!_&&r(null),children:e.jsxs(z,{className:"max-w-2xl max-h-[90vh] overflow-y-auto",children:[e.jsx(T,{children:e.jsxs(q,{className:"flex items-center gap-2",children:[e.jsx(U,{className:"h-5 w-5 text-blue-600"}),"Emitir NFS-e — ",a.clientes?.nome_fantasia||a.clientes?.razao_social]})}),e.jsxs("div",{className:"space-y-4 py-2",children:[c.valorTotal===0&&e.jsx("div",{className:"bg-amber-50 border border-amber-200 rounded-md p-3 text-xs text-amber-800",children:"⚠️ Valores do contrato não cadastrados. Configure em Clientes → editar cliente."}),e.jsxs("div",{className:"bg-blue-50 border border-blue-200 rounded-lg p-4 space-y-2",children:[e.jsx("p",{className:"text-sm font-semibold text-blue-900",children:"Cálculo do valor"}),e.jsxs("div",{className:"grid grid-cols-2 gap-2 text-xs",children:[e.jsx("span",{className:"text-muted-foreground",children:"Peso coletado:"}),e.jsxs("span",{className:"font-medium",children:[a.peso_coletado," ",a.unidade]}),e.jsx("span",{className:"text-muted-foreground",children:"Franquia:"}),e.jsxs("span",{className:"font-medium",children:[v(c.valorBase)," (",a.clientes?.peso_franquia||0," kg)"]}),c.pesoExcedente>0&&e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"text-muted-foreground",children:"Excedente:"}),e.jsxs("span",{className:"font-medium text-orange-600",children:[c.pesoExcedente.toFixed(3)," kg × ",v(a.clientes?.valor_kg_excedente||0)," = ",v(c.valorExcedente)]})]}),e.jsx("span",{className:"text-muted-foreground font-semibold",children:"Valor total:"}),e.jsx("span",{className:"font-bold text-blue-700 text-sm",children:v(c.valorTotal)}),e.jsxs("span",{className:"text-muted-foreground",children:["ISSQN (",o.aliquotaISSQN,"%):"]}),e.jsx("span",{className:"font-medium",children:v(L)})]})]}),e.jsxs("div",{className:"space-y-3",children:[e.jsx("p",{className:"text-sm font-semibold",children:"Dados para preencher no portal"}),[{label:"Tomador — CNPJ/CPF",value:a.clientes?.cnpj||""},{label:"Tomador — Razão Social",value:a.clientes?.razao_social||""},{label:"Tomador — Inscrição Municipal",value:a.clientes?.inscricao_municipal||"Não informado"},{label:"Código do Serviço",value:"07.09.01"},{label:"Descrição do Serviço",value:C},{label:"Valor do Serviço (R$)",value:c.valorTotal.toFixed(2).replace(".",",")},{label:"Competência",value:new Date(a.data_coleta+"T12:00:00").toLocaleDateString("pt-BR",{month:"2-digit",year:"numeric"})}].map(({label:_,value:S})=>e.jsxs("div",{className:"flex items-start justify-between gap-3 p-2.5 bg-muted/30 rounded-md border",children:[e.jsxs("div",{className:"flex-1 min-w-0",children:[e.jsx("p",{className:"text-xs text-muted-foreground mb-0.5",children:_}),e.jsx("p",{className:"text-sm font-medium break-all",children:S})]}),S&&S!=="Não informado"&&e.jsx(i,{variant:"ghost",size:"sm",className:"h-7 px-2 flex-shrink-0",onClick:()=>J(S),children:"Copiar"})]},_))]}),e.jsxs("div",{className:"text-xs text-muted-foreground bg-muted/20 rounded-md p-3",children:[e.jsxs("p",{className:"font-medium mb-1",children:["Prestador: ",o.fantasia]}),e.jsxs("p",{children:["CNPJ: ",o.cnpj," | IM: ",o.inscricaoMunicipal]}),e.jsxs("p",{children:["Regime: ",o.regime," | ISSQN: ",o.aliquotaISSQN,"%"]})]})]}),e.jsxs(M,{children:[e.jsx(i,{variant:"ghost",onClick:()=>r(null),children:"Fechar"}),e.jsxs(i,{className:"gap-2 bg-blue-600 hover:bg-blue-700",onClick:()=>window.open("https://www.isspnetonline.com.br/goiania/online/","_blank"),children:[e.jsx(U,{className:"h-4 w-4"})," Abrir Portal NFS-e"]})]})]})})})()]})}export{ga as component};
