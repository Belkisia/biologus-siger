import{d as ne,ah as he,r as h,j as e,I as K,C as O,m as ye,n as $,s as j,o as E,t as A,B as p,M as we,a as je,ai as Ne}from"./index-DcNmcuJV.js";import{L as le}from"./label-DAuysgm8.js";import{B as ae}from"./badge-CXaSGqHt.js";import{D as M,a as B,b as F,c as P,d as ie}from"./dialog-C_lQx_MY.js";import{C as Ce}from"./checkbox-CKQhWP2w.js";import{C as Se,a as Re}from"./check-check-DTAxrrqh.js";import{A as Ae}from"./arrow-right-ebkmuyhZ.js";import{P as Q}from"./printer-BsTUmd87.js";import{P as te}from"./plus-CnMVwJpF.js";import{F as J}from"./file-text-DBZeals2.js";import{U as se}from"./users-BfjOBAn9.js";import{L as V}from"./loader-circle-CsaiWUtl.js";import{E as ze}from"./eye-Chu_R1jb.js";import{P as Y}from"./pen-line-Cqqxg_3y.js";import{T as De}from"./trash-2-e3mCdT2m.js";import{S as Te}from"./search-BdDdaoQi.js";import{R as _e}from"./rotate-ccw-DOTjT9gg.js";import"./index-DmA6VlpE.js";import"./index-DAnikjNT.js";import"./index-D9DQ28h2.js";import"./index-DQBOpIAR.js";import"./index-Tbe3kPdk.js";import"./index-DBEvwDWv.js";import"./index-Dqb38b6-.js";import"./check-DeUYrZws.js";const ke=[["path",{d:"m15 18-6-6 6-6",key:"1wnfg3"}]],Ee=ne("chevron-left",ke);const Oe=[["path",{d:"M14.106 5.553a2 2 0 0 0 1.788 0l3.659-1.83A1 1 0 0 1 21 4.619v12.764a1 1 0 0 1-.553.894l-4.553 2.277a2 2 0 0 1-1.788 0l-4.212-2.106a2 2 0 0 0-1.788 0l-3.659 1.83A1 1 0 0 1 3 19.381V6.618a1 1 0 0 1 .553-.894l4.553-2.277a2 2 0 0 1 1.788 0z",key:"169xi5"}],["path",{d:"M15 5.764v15",key:"1pn4in"}],["path",{d:"M9 3.236v15",key:"1uimfh"}]],Le=ne("map",Oe),oe=[{id:"centro_aeroporto",label:"Centro / Aeroporto",semana:"S1",dias:"Seg–Sex"},{id:"campinas",label:"Campinas e Região",semana:"S1",dias:"2 dias"},{id:"vila_mutirao",label:"Vila Mutirão / Curitiba / Balneário",semana:"S1",dias:"2 dias"},{id:"senador_canedo",label:"Senador Canedo + Bela Vista",semana:"S1",dias:"1 dia"},{id:"nova_veneza",label:"Nova Veneza + Nerópolis",semana:"S1",dias:"1 dia"},{id:"setor_bueno",label:"Setor Bueno + Oeste",semana:"S2",dias:"2 dias"},{id:"setor_sul",label:"Setor Sul",semana:"S2",dias:"1 dia"},{id:"trindade",label:"Trindade",semana:"S2",dias:"1 dia"},{id:"itaberai",label:"Itaberaí",semana:"S2",dias:"2 dias"},{id:"quirinopolis",label:"Quirinópolis + Itumbiara",semana:"S2",dias:"1 dia"},{id:"morrinhos",label:"Morrinhos + Catalão",semana:"S2",dias:"1 dia"},{id:"aparecida",label:"Aparecida de Goiânia",semana:"S3",dias:"2 dias"},{id:"caldas_novas",label:"Caldas Novas",semana:"S3",dias:"1 dia"},{id:"anapolis",label:"Anápolis",semana:"S3",dias:"1 dia"},{id:"abadia_guapo",label:"Abadia / Guapó / Aragoiânia",semana:"S3",dias:"1 dia"},{id:"ipora",label:"Iporá e Região",semana:"S3/S1",dias:"2 dias"},{id:"inhumas",label:"Inhumas / Goianira / Caturaí",semana:"S4",dias:"2 dias"},{id:"vera_cruz",label:"Vera Cruz / Parque Oeste / Santa Rita",semana:"S4",dias:"1 dia"},{id:"brasilia",label:"Brasília",semana:"01/07",dias:"2 dias"},{id:"rio_verde",label:"Rio Verde",semana:"Semanal",dias:"Seg/Qua/Sex"},{id:"veterinaria",label:"Veterinária Quinzenal",semana:"Quinzenal",dias:"1 dia"}],Ie={S1:"bg-blue-100 text-blue-800",S2:"bg-teal-100 text-teal-800",S3:"bg-amber-100 text-amber-800",S4:"bg-purple-100 text-purple-800","S3/S1":"bg-orange-100 text-orange-800","01/07":"bg-red-100 text-red-800",Semanal:"bg-green-100 text-green-800",Quinzenal:"bg-pink-100 text-pink-800"};function $e(){return crypto.randomUUID()}function Me(t){const{numeroCDF:d,numeroMTR:b,dataEmissao:u,periodoInicio:g,periodoFim:r,cliente:o}=t,n=u?new Date(u+"T12:00:00").toLocaleDateString("pt-BR"):new Date().toLocaleDateString("pt-BR"),y=g?new Date(g+"T12:00:00").toLocaleDateString("pt-BR"):n,S=r?new Date(r+"T12:00:00").toLocaleDateString("pt-BR"):n,w=`https://biologus-siger.vercel.app/verificar-cdf/${d}`;return`<!DOCTYPE html>
<html lang="pt-BR">
<head>
  <meta charset="utf-8"/>
  <title>CDF ${d}</title>
...
<\/script>
    ...
    </div>`}).join("")}</body></html>`,r=window.open("","_blank");if(!r){alert("Permita popups para este site e tente novamente");return}r.document.write(g),r.document.close(),r.focus(),setTimeout(()=>r.print(),600)}function Fe(t,d){const b=window.open("","_blank");if(!b)return;const u=new Date(t.data_emissao+"T12:00:00").toLocaleDateString("pt-BR");b.document.write(`<!DOCTYPE html><html><head><title>MTR ${t.numero}</title>
  <style>
    *{box-sizing:border-box;margin:0;padding:0}
  ...
  <div class="header">
    ...
    <div><div class="mtr-title">MANIFESTO DE TRANSPORTE DE RESÍDUOS</div><div class="mtr-num">Nº ${t.numero} &nbsp;|&nbsp; ${u}</div></div>
  </div>
  <div class="section">
  ...
  <div class="assinaturas">
    <div class="ass-box">
      ...
      ${t.assinatura_gerador?`<img src="${t.assinatura_gerador}" style="max-width:100%;max-height:70px;display:block;margin:4px auto" /><div style="font-size:9px;color:#555;border-top:1px solid #555;padding-top:3px;margin-top:2px">${d.razao_social||""}</div>`:'<div class="ass-line">Assinatura / Carimbo</div>'}
    </div>
    <div class="ass-box">
  ...
  <script>window.onload=()=>window.print();<\/script>
  </body></html>`),b.document.close()}function re({onSave:t,onCancel:d,titulo:b}){const u=h.useRef(null),g=h.useRef(!1),r=h.useRef(null),o=(l,v)=>{const x=v.getBoundingClientRect(),z=v.width/x.width,_=v.height/x.height;return"touches"in l?{x:(l.touches[0].clientX-x.left)*z,y:(l.touches[0].clientY-x.top)*_}:{x:(l.clientX-x.left)*z,y:(l.clientY-x.top)*_}},n=l=>{l.preventDefault();const v=u.current;v&&(g.current=!0,r.current=o(l,v))},y=l=>{if(l.preventDefault(),!g.current)return;const v=u.current,x=v?.getContext("2d");if(!v||!x||!r.current)return;const z=o(l,v);x.beginPath(),x.moveTo(r.current.x,r.current.y),x.lineTo(z.x,z.y),x.strokeStyle="#000",x.lineWidth=2.5,x.lineCap="round",x.lineJoin="round",x.stroke(),r.current=z},S=()=>{g.current=!1,r.current=null},w=()=>{const l=u.current,v=l?.getContext("2d");!l||!v||v.clearRect(0,0,l.width,l.height)},T=()=>{const l=u.current;l&&t(l.toDataURL("image/png"))};return e.jsxs("div",{className:"flex flex-col gap-3",children:[e.jsx("p",{className:"text-sm font-medium text-center",children:b}),e.jsx("div",{className:"border-2 border-dashed border-border rounded-lg bg-white touch-none",style:{touchAction:"none"},children:e.jsx("canvas",{ref:u,width:600,height:200,className:"w-full rounded-lg",style:{touchAction:"none"},onMouseDown:n,onMouseMove:y,onMouseUp:S,onMouseLeave:S,onTouchStart:n,onTouchMove:y,onTouchEnd:S})}),e.jsx("p",{className:"text-xs text-muted-foreground text-center",children:"Assine acima com o dedo ou caneta"}),e.jsxs("div",{className:"flex gap-2 justify-between",children:[e.jsxs(p,{variant:"outline",size:"sm",onClick:w,children:[e.jsx(_e,{className:"h-4 w-4 mr-1"})," Limpar"]}),e.jsxs("div",{className:"flex gap-2",children:[e.jsx(p,{variant:"ghost",size:"sm",onClick:d,children:"Cancelar"}),e.jsxs(p,{size:"sm",onClick:T,children:[e.jsx(Y,{className:"h-4 w-4 mr-1"})," Salvar Assinatura"]})]})]})]})}function Pe({rota:t,dataSelecionada:d,onVoltar:b,user:u}){const g=ye(),r=g,[o,n]=h.useState(!1),[y,S]=h.useState(""),[w,T]=h.useState([]),[l,v]=h.useState(!1),[x,z]=h.useState("GRUPO A, B, E INFECTANTES, QUIMICOS E PERFURO CORTANTES"),[_,ce]=h.useState("lista"),[D,k]=h.useState(null),[R,L]=h.useState(null),{data:c=[],isLoading:pe}=$({queryKey:["rota-clientes",t.id],queryFn:async()=>{const{data:a}=await j.from("rota_clientes").select("id, ordem, coletado, clientes(id, razao_social, nome_fantasia, logradouro, cidade, cnpj, latitude, longitude)").eq("rota_codigo",t.id).order("ordem");return(a??[]).map(i=>({id:i.id,ordem:i.ordem,coletado:i.coletado??!1,cliente:i.clientes})).filter(i=>i.cliente)}}),{data:N=[]}=$({queryKey:["mtrs-rota",t.id,d],queryFn:async()=>{if(!c.length)return[];const{data:a}=await j.from("mtrs").select("id, numero, cliente_id, status, quantidade, unidade, data_emissao, descricao_residuo, acondicionamento, assinatura_gerador, assinatura_transportador, data_baixa").eq("rota_codigo",t.id).eq("data_emissao",d);return a??[]},enabled:c.length>0}),{data:me=[]}=$({queryKey:["cdfs-rota",t.id,d],queryFn:async()=>{const{data:a}=await j.from("boletins_medicao").select("id, mtr_id, cdf_id, cdf_enviado, numero").in("mtr_id",N.map(i=>i.id));return a??[]},enabled:N.length>0}),{data:H=[]}=$({queryKey:["clientes-select"],queryFn:async()=>{const{data:a}=await j.from("clientes").select("id, razao_social, nome_fantasia, logradouro, cidade").eq("ativo",!0).order("razao_social",{ascending:!0});return a??[]}}),I=new Set(c.map(a=>a.cliente.id)),q=E({mutationFn:async()=>{const a=w.map((s,m)=>({owner_id:u.id,rota_codigo:t.id,rota_id:null,cliente_id:s,ordem:c.length+m+1,frequencia:"semanal",coletado:!1})),{error:i}=await j.from("rota_clientes").upsert(a,{onConflict:"rota_codigo,cliente_id"});if(i)throw i},onSuccess:()=>{g.invalidateQueries({queryKey:["rota-clientes"]}),A.success(`${w.length} clientes adicionados`),n(!1),T([])},onError:a=>A.error(a.message)}),xe=E({mutationFn:async({mtrId:a,peso:i,cliente:s})=>{const m=new Date().toISOString().split("T")[0],f=$e(),{data:C,error:W}=await j.from("mtrs").update({status:"baixado",quantidade:i,data_baixa:m}).eq("id",a).select("id, numero, cliente_id, rota_codigo, descricao_residuo, unidade, data_emissao").single();if(W)throw W;const{data:be,error:ee}=await j.from("boletins_medicao").insert([{owner_id:u.id,mtr_id:C.id,cliente_id:C.cliente_id,data_coleta:m,peso_coletado:i,unidade:C.unidade||"kg",status:"pendente",pagamento_confirmado:!1,cdf_enviado:!1,cdf_id:f,numero:f}]).select("id").single();if(ee)throw ee;return{mtrData:C,boletimData:be,numeroCDF:f,cliente:s}},onSuccess:({mtrData:a,numeroCDF:i,cliente:s})=>{r.invalidateQueries({queryKey:["mtrs-rota"]}),r.invalidateQueries({queryKey:["cdfs-rota"]}),A.success("MTR baixado! Boletim e CDF gerados.");const m=new Date().toISOString().split("T")[0],f=de({numeroCDF:i,numeroMTR:a.numero,dataEmissao:m,periodoInicio:a.data_emissao||m,periodoFim:m,cliente:s});L({blobUrl:f,numeroCDF:i})},onError:a=>A.error(a.message)}),X=E({mutationFn:async({mtrId:a,campo:i,dataUrl:s})=>{const{error:m}=await j.from("mtrs").update({[i]:s}).eq("id",a);if(m)throw m},onSuccess:()=>{r.invalidateQueries({queryKey:["mtrs-rota"]}),A.success("Assinatura salva!")}}),fe=E({mutationFn:async a=>{const{error:i}=await j.from("rota_clientes").delete().eq("id",a);if(i)throw i},onSuccess:()=>{g.invalidateQueries({queryKey:["rota-clientes"]}),A.success("Cliente removido")}}),ue=E({mutationFn:async({rcId:a,coletado:i})=>{const{error:s}=await j.from("rota_clientes").update({coletado:i}).eq("id",a);if(s)throw s},onSuccess:()=>g.invalidateQueries({queryKey:["rota-clientes"]})}),G=E({mutationFn:async()=>{const a=c.map((s,m)=>({owner_id:u.id,cliente_id:s.cliente.id,numero:`MTR-${d.replace(/-/g,"")}-${String(m+1).padStart(3,"0")}`,data_emissao:d,descricao_residuo:x,quantidade:0,unidade:"kg",acondicionamento:"BOMBONA",status:"emitido",rota_codigo:t.id})),{error:i}=await j.from("mtrs").insert(a);if(i)throw i},onSuccess:()=>{g.invalidateQueries({queryKey:["mtrs-rota"]}),g.invalidateQueries({queryKey:["mtrs"]}),A.success(`${c.length} MTRs criados!`),v(!1)},onError:a=>A.error(a.message)}),ge=()=>{const a=window.open("","_blank");if(!a)return;const i=new Date(d+"T12:00:00").toLocaleDateString("pt-BR");a.document.write(`<!DOCTYPE html><html><head><title>Rota ${t.label}</title>
    <style>
    ...
    <script>window.onload=()=>window.print();<\/script>
    </body></html>`),a.document.close()},ve=H.filter(a=>{const i=y.toLowerCase();return!i||(a.nome_fantasia||a.razao_social).toLowerCase().includes(i)||(a.cidade??"").toLowerCase().includes(i)}),U=c.filter(a=>a.coletado).length,Z=c.length>0?Math.round(U/c.length*100):0;return e.jsxs("div",{className:"space-y-4",children:[e.jsxs("div",{className:"flex items-center gap-3 flex-wrap",children:[e.jsxs(p,{variant:"ghost",size:"sm",onClick:b,children:[e.jsx(Ee,{className:"h-4 w-4 mr-1"})," Rotas"]}),e.jsxs("div",{className:"flex-1",children:[e.jsxs("h1",{className:"text-xl font-bold flex items-center gap-2",children:[e.jsx(we,{className:"h-5 w-5 text-primary"}),t.label]}),e.jsxs("p",{className:"text-xs text-muted-foreground mt-0.5",children:[new Date(d+"T12:00:00").toLocaleDateString("pt-BR")," · Semana ",t.semana," · ",t.dias]})]}),e.jsxs("div",{className:"flex gap-2",children:[e.jsxs(p,{variant:"outline",size:"sm",onClick:ge,children:[e.jsx(Q,{className:"h-4 w-4 mr-1"})," Imprimir"]}),N.length>0&&e.jsxs(p,{variant:"outline",size:"sm",onClick:()=>Be(N,c),children:[e.jsx(Q,{className:"h-4 w-4 mr-1"})," MTRs em lote"]}),e.jsxs(p,{variant:"outline",size:"sm",onClick:()=>n(!0),children:[e.jsx(te,{className:"h-4 w-4 mr-1"})," Clientes"]}),e.jsxs(p,{size:"sm",onClick:()=>v(!0),disabled:c.length===0||N.length>0,children:[e.jsx(J,{className:"h-4 w-4 mr-1"}),N.length>0?`${N.length} MTRs emitidos`:"Gerar MTRs"]})]})]}),e.jsx("div",{className:"grid grid-cols-4 gap-3",children:[{label:"Clientes",val:c.length,color:"text-primary"},{label:"Coletados",val:U,color:"text-green-600"},{label:"Pendentes",val:c.length-U,color:"text-amber-600"},{label:"MTRs",val:N.length,color:"text-teal-600"}].map(a=>e.jsxs(O,{className:"p-3 text-center",children:[e.jsx("p",{className:`text-2xl font-bold ${a.color}`,children:a.val}),e.jsx("p",{className:"text-xs text-muted-foreground",children:a.label})]},a.label))}),c.length>0&&e.jsxs(O,{className:"p-3",children:[e.jsxs("div",{className:"flex justify-between text-sm mb-1.5",children:[e.jsx("span",{className:"text-muted-foreground",children:"Progresso da coleta"}),e.jsxs("span",{className:"font-bold text-primary",children:[Z,"%"]})]}),e.jsx("div",{className:"w-full bg-muted rounded-full h-2.5",children:e.jsx("div",{className:"bg-green-500 h-2.5 rounded-full transition-all",style:{width:`${Z}%`}})})]}),e.jsx("div",{className:"flex border-b",children:[{id:"lista",icon:se,label:"Lista"},{id:"mapa",icon:Le,label:"Mapa"}].map(a=>e.jsxs("button",{onClick:()=>ce(a.id),className:`flex items-center gap-1.5 px-4 py-2 text-sm font-medium border-b-2 transition-colors ${_===a.id?"border-primary text-primary":"border-transparent text-muted-foreground"}`,children:[e.jsx(a.icon,{className:"h-4 w-4"}),a.label]},a.id))}),_==="lista"&&e.jsx(O,{children:pe?e.jsx("div",{className:"py-12 text-center",children:e.jsx(V,{className:"h-5 w-5 animate-spin mx-auto text-muted-foreground"})}):c.length===0?e.jsxs("div",{className:"py-12 text-center",children:[e.jsx(se,{className:"h-10 w-10 mx-auto text-muted-foreground/30 mb-3"}),e.jsx("p",{className:"text-sm text-muted-foreground",children:"Nenhum cliente vinculado."}),e.jsxs(p,{size:"sm",className:"mt-3",onClick:()=>n(!0),children:[e.jsx(te,{className:"h-4 w-4 mr-1"})," Adicionar clientes"]})]}):e.jsx("div",{className:"divide-y",children:c.map((a,i)=>{const s=N.find(f=>f.cliente_id===a.cliente.id),m=me.find(f=>f.mtr_id===s?.id);return e.jsxs("div",{className:`flex items-center gap-3 px-4 py-3 transition-colors ${a.coletado?"bg-green-50/50":""}`,children:[e.jsx("button",{onClick:()=>ue.mutate({rcId:a.id,coletado:!a.coletado}),className:"flex-shrink-0",children:a.coletado?e.jsx(je,{className:"h-6 w-6 text-green-500"}):e.jsx(Ne,{className:"h-6 w-6 text-muted-foreground/30"})}),e.jsx("div",{className:`flex-shrink-0 w-7 h-7 rounded-full flex items-center justify-center text-xs font-bold ${a.coletado?"bg-green-500 text-white":"bg-primary text-white"}`,children:i+1}),e.jsxs("div",{className:"flex-1 min-w-0",children:[e.jsx("p",{className:`text-sm font-medium truncate ${a.coletado?"line-through text-muted-foreground":""}`,children:a.cliente.nome_fantasia||a.cliente.razao_social}),e.jsxs("p",{className:"text-xs text-muted-foreground truncate",children:[a.cliente.logradouro||"",a.cliente.cidade?` — ${a.cliente.cidade}`:""]})]}),e.jsxs("div",{className:"flex items-center gap-2 flex-shrink-0",children:[s&&e.jsxs(e.Fragment,{children:[e.jsx(ae,{variant:s.status==="baixado"?"default":"secondary",className:`text-xs ${s.status==="baixado"?"bg-green-500":""}`,children:s.status==="baixado"?`${s.quantidade}kg ✓`:s.numero}),s.status!=="baixado"&&e.jsx(p,{variant:"ghost",size:"icon",className:"h-7 w-7",title:"Dar baixa no MTR",onClick:()=>{const f=window.prompt(`Peso coletado (kg) — ${a.cliente.nome_fantasia||a.cliente.razao_social}:`);if(f===null)return;const C=parseFloat(f.replace(",","."))||0;xe.mutate({mtrId:s.id,peso:C,cliente:a.cliente})},children:e.jsx(Re,{className:"h-3.5 w-3.5 text-orange-500"})}),s.status==="baixado"&&m?.cdf_id&&e.jsx(p,{variant:"ghost",size:"icon",className:"h-7 w-7",title:`Visualizar CDF ${m.cdf_id}`,onClick:()=>{const f=new Date().toISOString().split("T")[0],C=de({numeroCDF:m.cdf_id??"",numeroMTR:s.numero,dataEmissao:s.data_emissao||f,periodoInicio:s.data_emissao||f,periodoFim:s.data_baixa||f,cliente:a.cliente});L({blobUrl:C,numeroCDF:m.cdf_id??""})},children:e.jsx(ze,{className:"h-3.5 w-3.5 text-green-600"})}),e.jsx(p,{variant:"ghost",size:"icon",className:"h-7 w-7",title:"Assinar MTR",onClick:()=>k({mtr:s,cliente:a.cliente,etapa:"gerador"}),children:e.jsx(Y,{className:`h-3.5 w-3.5 ${s.assinatura_gerador?"text-green-500":"text-muted-foreground"}`})}),e.jsx(p,{variant:"ghost",size:"icon",className:"h-7 w-7",title:"Imprimir MTR",onClick:()=>Fe(s,a.cliente),children:e.jsx(Q,{className:"h-3.5 w-3.5 text-primary"})})]}),e.jsx(p,{variant:"ghost",size:"icon",className:"h-7 w-7",onClick:()=>fe.mutate(a.id),children:e.jsx(De,{className:"h-3.5 w-3.5 text-muted-foreground"})})]})]},a.id)})})}),_==="mapa"&&e.jsxs(O,{className:"overflow-hidden",children:[e.jsx("div",{id:"mapa-rota",style:{height:420}}),e.jsx("script",{dangerouslySetInnerHTML:{__html:`
