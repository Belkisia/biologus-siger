import{m as k,r as N,V as K,n as E,s as x,o as C,t as u,j as e,B as v,I as l,C as D}from"./index-B8MdfOud.js";import{L as t}from"./label-DJabGeCE.js";import{T as J}from"./textarea-Bq9DDgR8.js";import{S as f,a as h,d as T,b as g,c as b}from"./select-DyeHeJ9B.js";import{D as H,e as Y,a as Z,b as W,c as X,d as ee}from"./dialog-Bg6OJvhq.js";import{T as se,a as ae,b as I,c as r,d as ie,e as n}from"./table-_BtO5ELe.js";import{D as de,O as te}from"./document-upload-ZWwBMerf.js";import{P as oe}from"./plus-eC7JJBww.js";import{L as M}from"./loader-circle-B5CooStl.js";import{S as le}from"./search-CEpuKlsP.js";import{F as re}from"./file-text-DEWH4cej.js";import{P as ne}from"./printer-CexeVDBl.js";import{T as ce}from"./trash-2-CNDrg8RA.js";import"./index-DHhzCx6-.js";import"./index-VKBUg_vy.js";import"./index-BKt155bW.js";import"./index-D0lS4CND.js";import"./index-m_gNzzJG.js";import"./index-73auj8Ju.js";import"./index-CVz5J1O1.js";import"./index-guLrPPtY.js";import"./check-DD94AczW.js";import"./index-CiJy1hYR.js";import"./index-D0v0PrNh.js";import"./upload-CLeYAbZO.js";import"./external-link-Dn8C-QGC.js";const j={emitido:{label:"Emitido",color:"bg-blue-100 text-blue-800"},em_transporte:{label:"Em Transporte",color:"bg-amber-100 text-amber-800"},recebido:{label:"Recebido",color:"bg-purple-100 text-purple-800"},destinado:{label:"Destinado",color:"bg-green-100 text-green-800"},cancelado:{label:"Cancelado",color:"bg-red-100 text-red-800"}},me=["Classe I — Perigoso","Classe IIA — Não inerte","Classe IIB — Inerte"],pe=["Aterro Industrial","Incineração","Co-processamento","Reciclagem","Compostagem","Autoclavagem","Tratamento Químico"];function xe(d){const m=window.open("","_blank");if(!m)return;const o=d.clientes,_=new Date(d.data_emissao+"T12:00:00").toLocaleDateString("pt-BR");m.document.write(`<!DOCTYPE html><html><head><title>MTR ${d.numero}</title>
  <style>
  ...
  <div class="section">
    ...
    <div class="section-body">
      <div class="grid2">
        <div class="field"><div class="field-label">Razão Social</div><div class="field-value">${d.destinador??"ECO INCINERAR GESTAO AMBIENTAL LTDA"}</div></div>
        ...
        <div class="field"><div class="field-label">Tecnologia</div><div class="field-value">${d.tecnologia_destinacao??"Incineração"}</div></div>
  ...
  </body></html>`),m.document.close()}function $e(){const d=k(),[m,o]=N.useState(!1),[_,S]=N.useState(null),[y,L]=N.useState(""),[A,F]=N.useState("todos"),{user:z}=K.useRouteContext(),{data:w=[]}=E({queryKey:["clientes-select"],queryFn:async()=>{const{data:s}=await x.from("clientes").select("id, razao_social, fantasia").order("razao_social",{ascending:!0});return s??[]}}),{data:p=[],isLoading:B}=E({queryKey:["mtrs"],queryFn:async()=>{const{data:s,error:a}=await x.from("mtrs").select("*, clientes(razao_social, fantasia, logradouro, cidade, cnpj)").order("data_emissao",{ascending:!1});if(a)throw a;return s}}),O=p.filter(s=>{const a=y.toLowerCase(),i=!y||s.numero.toLowerCase().includes(a)||(s.clientes?.razao_social??"").toLowerCase().includes(a)||(s.clientes?.fantasia??"").toLowerCase().includes(a),c=A==="todos"||s.status===A;return i&&c}),R=C({mutationFn:async s=>{const{error:a}=await x.from("mtrs").insert([{...s,owner_id:z.id}]);if(a)throw a},onSuccess:()=>{d.invalidateQueries({queryKey:["mtrs"]}),u.success("MTR registrado"),S(null),o(!1)},onError:s=>u.error(s.message)}),q=C({mutationFn:async({id:s,status:a})=>{const{error:i}=await x.from("mtrs").update({status:a}).eq("id",s);if(i)throw i},onSuccess:()=>d.invalidateQueries({queryKey:["mtrs"]})}),$=C({mutationFn:async s=>{const{error:a}=await x.from("mtrs").delete().eq("id",s);if(a)throw a},onSuccess:()=>{d.invalidateQueries({queryKey:["mtrs"]}),u.success("MTR removido")},onError:s=>u.error(s.message)}),P=s=>{s.preventDefault();const a=new FormData(s.currentTarget),i={};if(a.forEach((c,Q)=>{c!==""&&(i[Q]=c)}),!i.cliente_id||!i.numero||!i.descricao_residuo)return u.error("Preencha cliente, número e descrição");i.quantidade&&(i.quantidade=Number(i.quantidade)),i.url_documento=_,R.mutate(i)},V=p.reduce((s,a)=>s+(a.unidade==="kg"?Number(a.quantidade):0),0),U=p.filter(s=>s.status==="destinado").length,G=p.filter(s=>["emitido","em_transporte"].includes(s.status)).length;return e.jsxs("div",{className:"space-y-6",children:[e.jsxs("div",{className:"flex items-start justify-between flex-wrap gap-4",children:[e.jsxs("div",{children:[e.jsx("h1",{className:"text-2xl font-bold text-foreground",children:"MTR — Manifesto de Transporte de Resíduos"}),e.jsx("p",{className:"text-sm text-muted-foreground",children:"Rastreabilidade legal do gerador ao destino final."})]}),e.jsxs(H,{open:m,onOpenChange:o,children:[e.jsx(Y,{asChild:!0,children:e.jsxs(v,{disabled:w.length===0,children:[e.jsx(oe,{className:"h-4 w-4 mr-2"}),"Novo MTR"]})}),e.jsxs(Z,{className:"max-w-3xl max-h-[90vh] overflow-y-auto",children:[e.jsx(W,{children:e.jsx(X,{children:"Registrar MTR"})}),e.jsxs("form",{onSubmit:P,className:"space-y-4",children:[e.jsxs("div",{className:"grid md:grid-cols-2 gap-4",children:[e.jsxs("div",{className:"space-y-2",children:[e.jsx(t,{children:"Cliente (Gerador) *"}),e.jsxs(f,{name:"cliente_id",required:!0,children:[e.jsx(h,{children:e.jsx(T,{placeholder:"Selecione"})}),e.jsx(g,{children:w.map(s=>e.jsx(b,{value:s.id,children:s.fantasia||s.razao_social},s.id))})]})]}),e.jsxs("div",{className:"space-y-2",children:[e.jsx(t,{htmlFor:"numero",children:"Nº MTR *"}),e.jsx(l,{id:"numero",name:"numero",required:!0,placeholder:"MTR-2026-0001"})]}),e.jsxs("div",{className:"space-y-2",children:[e.jsx(t,{htmlFor:"data_emissao",children:"Data de emissão"}),e.jsx(l,{id:"data_emissao",name:"data_emissao",type:"date",defaultValue:new Date().toISOString().slice(0,10)})]}),e.jsxs("div",{className:"space-y-2",children:[e.jsx(t,{children:"Classe IBAMA"}),e.jsxs(f,{name:"classe_ibama",children:[e.jsx(h,{children:e.jsx(T,{placeholder:"Selecione"})}),e.jsx(g,{children:me.map(s=>e.jsx(b,{value:s,children:s},s))})]})]}),e.jsxs("div",{className:"space-y-2",children:[e.jsx(t,{htmlFor:"codigo_residuo",children:"Código IBAMA"}),e.jsx(l,{id:"codigo_residuo",name:"codigo_residuo",placeholder:"ex.: 180103"})]}),e.jsxs("div",{className:"space-y-2",children:[e.jsx(t,{htmlFor:"acondicionamento",children:"Acondicionamento"}),e.jsx(l,{id:"acondicionamento",name:"acondicionamento",defaultValue:"BOMBONA"})]}),e.jsxs("div",{className:"space-y-2 md:col-span-2",children:[e.jsx(t,{htmlFor:"descricao_residuo",children:"Descrição do resíduo *"}),e.jsx(l,{id:"descricao_residuo",name:"descricao_residuo",required:!0,defaultValue:"GRUPO A, B, E INFECTANTES, QUIMICOS E PERFURO CORTANTES"})]}),e.jsxs("div",{className:"space-y-2",children:[e.jsx(t,{htmlFor:"quantidade",children:"Quantidade"}),e.jsx(l,{id:"quantidade",name:"quantidade",type:"number",step:"0.001"})]}),e.jsxs("div",{className:"space-y-2",children:[e.jsx(t,{children:"Unidade"}),e.jsxs(f,{name:"unidade",defaultValue:"kg",children:[e.jsx(h,{children:e.jsx(T,{})}),e.jsx(g,{children:["kg","ton","L","m3","un"].map(s=>e.jsx(b,{value:s,children:s},s))})]})]}),e.jsxs("div",{className:"space-y-2",children:[e.jsx(t,{htmlFor:"transportador",children:"Transportador"}),e.jsx(l,{id:"transportador",name:"transportador",defaultValue:"ATIVA COMERCIAL COMERCIO E SERVICOS LTDA"})]}),e.jsxs("div",{className:"space-y-2",children:[e.jsx(t,{htmlFor:"destinador",children:"Destinador"}),e.jsx(l,{id:"destinador",name:"destinador",defaultValue:"ECO INCINERAR GESTAO AMBIENTAL LTDA"})]}),e.jsxs("div",{className:"space-y-2 md:col-span-2",children:[e.jsx(t,{children:"Tecnologia de destinação"}),e.jsxs(f,{name:"tecnologia_destinacao",defaultValue:"Incineração",children:[e.jsx(h,{children:e.jsx(T,{})}),e.jsx(g,{children:pe.map(s=>e.jsx(b,{value:s,children:s},s))})]})]}),e.jsx("div",{className:"space-y-2 md:col-span-2",children:e.jsx(de,{folder:"mtrs",value:_,onChange:S,label:"Documento (PDF)"})}),e.jsxs("div",{className:"space-y-2 md:col-span-2",children:[e.jsx(t,{htmlFor:"observacoes",children:"Observações"}),e.jsx(J,{id:"observacoes",name:"observacoes",rows:2})]})]}),e.jsxs(ee,{children:[e.jsx(v,{type:"button",variant:"ghost",onClick:()=>o(!1),children:"Cancelar"}),e.jsxs(v,{type:"submit",disabled:R.isPending,children:[R.isPending&&e.jsx(M,{className:"h-4 w-4 mr-2 animate-spin"}),"Registrar"]})]})]})]})]})]}),e.jsx("div",{className:"grid grid-cols-2 lg:grid-cols-4 gap-4",children:[{label:"Total de MTRs",val:p.length,color:"text-foreground"},{label:"Em aberto",val:G,color:"text-amber-600"},{label:"Destinados",val:U,color:"text-green-600"},{label:"Volume (kg)",val:V.toLocaleString("pt-BR"),color:"text-primary"}].map(s=>e.jsxs(D,{className:"p-4",children:[e.jsx("p",{className:"text-xs text-muted-foreground uppercase tracking-wider",children:s.label}),e.jsx("p",{className:`text-2xl font-bold mt-1 ${s.color}`,children:s.val})]},s.label))}),e.jsxs("div",{className:"flex gap-3 flex-wrap items-center",children:[e.jsxs("div",{className:"relative flex-1 min-w-48",children:[e.jsx(le,{className:"absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-muted-foreground"}),e.jsx(l,{placeholder:"Buscar MTR ou cliente...",value:y,onChange:s=>L(s.target.value),className:"pl-9"})]}),e.jsx("div",{className:"flex gap-1",children:["todos",...Object.keys(j)].map(s=>e.jsx("button",{onClick:()=>F(s),className:`text-xs px-3 py-1.5 rounded-full border transition-colors ${A===s?"bg-primary text-primary-foreground border-primary":"border-border text-muted-foreground hover:border-primary/40"}`,children:s==="todos"?"Todos":j[s]?.label},s))})]}),e.jsx(D,{children:B?e.jsx("div",{className:"py-12 text-center",children:e.jsx(M,{className:"h-6 w-6 mx-auto animate-spin text-muted-foreground"})}):O.length===0?e.jsxs("div",{className:"py-16 text-center",children:[e.jsx(re,{className:"h-10 w-10 mx-auto text-muted-foreground/40"}),e.jsx("p",{className:"mt-3 text-sm text-muted-foreground",children:"Nenhum MTR encontrado."})]}):e.jsxs(se,{children:[e.jsx(ae,{children:e.jsxs(I,{children:[e.jsx(r,{children:"Nº MTR"}),e.jsx(r,{children:"Emissão"}),e.jsx(r,{children:"Gerador"}),e.jsx(r,{children:"Resíduo"}),e.jsx(r,{children:"Qtd."}),e.jsx(r,{children:"Status"}),e.jsx(r,{className:"w-28"})]})}),e.jsx(ie,{children:O.map(s=>{const a=j[s.status]??j.emitido;return e.jsxs(I,{children:[e.jsx(n,{className:"font-medium",children:s.numero}),e.jsx(n,{className:"text-sm",children:new Date(s.data_emissao+"T12:00:00").toLocaleDateString("pt-BR")}),e.jsx(n,{className:"text-sm",children:s.clientes?.fantasia??s.clientes?.razao_social??"—"}),e.jsxs(n,{children:[e.jsx("div",{className:"text-sm truncate max-w-48",children:s.descricao_residuo}),s.classe_ibama&&e.jsx("div",{className:"text-xs text-muted-foreground",children:s.classe_ibama})]}),e.jsx(n,{className:"text-sm whitespace-nowrap font-semibold",children:Number(s.quantidade)>0?`${Number(s.quantidade)} ${s.unidade}`:"—"}),e.jsx(n,{children:e.jsxs(f,{value:s.status,onValueChange:i=>q.mutate({id:s.id,status:i}),children:[e.jsx(h,{className:"w-36 h-7 border-0 p-0",children:e.jsx("span",{className:`text-xs px-2 py-0.5 rounded-full font-medium ${a.color}`,children:a.label})}),e.jsx(g,{children:Object.entries(j).map(([i,c])=>e.jsx(b,{value:i,children:c.label},i))})]})}),e.jsx(n,{children:e.jsxs("div",{className:"flex items-center gap-1",children:[e.jsx(v,{variant:"ghost",size:"icon",className:"h-8 w-8",onClick:()=>xe(s),title:"Imprimir MTR",children:e.jsx(ne,{className:"h-4 w-4"})}),e.jsx(te,{path:s.url_documento}),e.jsx(v,{variant:"ghost",size:"icon",className:"h-8 w-8",onClick:()=>{confirm(`Remover MTR ${s.numero}?`)&&$.mutate(s.id)},children:e.jsx(ce,{className:"h-4 w-4 text-destructive"})})]})})]},s.id)})})]})})]})}export{$e as component};
